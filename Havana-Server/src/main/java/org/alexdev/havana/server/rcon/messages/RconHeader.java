...
public enum RconHeader {
    ...
    REFRESH_ITEM_DEFINITIONS("refreshitemdefinitions"),
    REFRESH_NAVIGATOR("refreshnavigator"),
    REFRESH_ROOM_MODELS("refreshroommodels"),
    REFRESH_WORDFILTER("refreshwordfilter"),
    REFRESH_ECOTRON("refreshecotron"),
    ...
    REFRESH_CATALOGUE("refreshcatalogue"),
