   ...
   <body id="frontpage">
      <div id="fp-container">
         <div id="header" class="clearfix">
            ...
            ¿Nuev@?
            <a href="{{ site.sitePath }}/register">REGISTRATE GRATIS</a>
            </span>
         </div>
         <div id="content">
  ...
  <ul>
   <li>{{ alert.message }}</li>
				...
				{% endif %}
                           ...
                           <form action="{{ site.sitePath }}/account/submit" method="post" class="login-habblet">
                              <ul>
                                 ...
                                 <li id="register-link" class="no-label">
                                    <a href="{{ site.sitePath }}/register" class="login-register-link"><span>Registrate gratis</span></a>
                                 </li>
                                 <li class="no-label">
                                    <a href="{{ site.sitePath }}/account/password/forgot" id="forgot-password"><span>Olvide mi contraseña</span></a>
                                 </li>
                              </ul>
                              <div id="remember-me-notification" class="bottom-bubble" style="display:none;">
                                 ...
                                 <div class="bottom-bubble-c">
                                    Seleccionando ''Recuerdame'' quedaras logeado en esta pc hasta que hagas clic en ''Salir''. Si esta PC es publica no es recomendable que actives esta función.
                                 </div>
                  ...
                  <script type="text/javascript">
                     L10N.put("authentication.form.name", "Usuario");
               ...
               <div class="habblet-container ">
                  ...
                  <script type="text/javascript">
                     ...
                     var i = 0;
					sb.add("fp-bubble-"+i++, "frontpage-image", 489, 143, "Crea tu propio Habbo...");
					sb.add("fp-bubble-"+i++, "frontpage-image", 478, 254, "...¡Y haz nuevos amigos!");
					sb.add("fp-bubble-"+i++, "frontpage-image", 93, 249, "Unete al mayor mundo virtual.");
            ...
            <div id="column-footer">
               <div class="habblet-container ">
                  <div class="cbb" id="hotel-stats">
                     <ul class="stats">
                        <li class="stats-online"><span class="stats-fig">{{ site.usersOnline }}</span> {{ site.siteName }}s Conectados</li>
                        <li class="stats-visited"><span class="stats-fig">{{ site.visits }}</span> Visitas unicas en los ultimos días</li>
                     </ul>
                  </div>
               </div>
               <script type="text/javascript">if (!$(document.body).hasClassName('process-template')) { Rounder.init(); }</script>
               <div class="habblet-container ">
                  <div class="cbb habblet box-content" id="tag-cloud-slim">
                     <span class="tags-habbos-like">Los {{ site.siteName }}s estan locos por...</span>
                     <ul class="tag-list">
						{% autoescape 'html' %}
						...
						{% endfor %}
						{% else %}
						<li><span class="tags-habbos-like">No hay YoSoy para mostrar.</span></li>
						{% endif %}
						{% endautoescape %}
                     </ul>
                  </div>
