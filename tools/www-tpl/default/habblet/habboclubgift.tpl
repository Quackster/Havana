<div class="box-content">
    <div id="hc-catalog">
	  ...
	  {% if currentPage != 1 %}
      <div class="hc-catalog-navi">
        <a href="/credits/habboclub?month=0&catalogpage=0" onclick="return habboclub.catalogUpdate({{ currentPage - 1}}, 0)">{{ locale.habblet_habboclubgift_previous }}</a>
      </div>
	  {% else %}
	  <div class="hc-catalog-navi">
	    {{ locale.habblet_habboclubgift_previous }}
	  </div>
	  {% endif %}
    ...
    {% endfor %}
	 ...
	 {% if currentPage != lastPage %}
	  <div class="hc-catalog-monthNumber">
        <a href="/credits/habboclub?month=0&catalogpage=0" onclick="return habboclub.catalogUpdate({{ currentPage + 1 }}, 0)">{{ locale.habblet_habboclubgift_next }}</a>
      </div>
	  {% else %}
	  <div class="hc-catalog-monthNumber">
        {{ locale.habblet_habboclubgift_next }}
      </div>
	  {% endif %}
