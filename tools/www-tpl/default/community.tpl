...
<head>
	...
	<title>{{ site.siteName }}{{ locale.community_community }} </title>

<script type="text/javascript">
var andSoItBegins = (new Date()).getTime();
</script>
    <link rel="shortcut icon" href="{{ site.staticContentPath }}/web-gallery/v2/favicon.ico" type="image/vnd.microsoft.icon" />
    <link rel="alternate" type="application/rss+xml" title="{{ site.siteName }}{{ locale.community_rss }}" href="{{ site.sitePath }}/articles/rss.xml" />
...
var habboName = "{{ locale.community_session_loggedin_playerdetails_getname|escape('js') }} "" }}";
var ad_keywords = "";
...
<meta name="description" content="{{ locale.community_join_the_world_s_largest_virtual_hangout_where_you_can_meet_and_make_friends_design_your_own_rooms_collect_cool_furniture_throw_parties_and_so_much_more_create_your_free }} {{ site.siteName }} {{ locale.community_today }}" />
<meta name="keywords" content="{{ site.siteName }}{{ locale.community_virtual_world_join_groups_forums_play_games_online_friends_teens_collecting_social_network_create_collect_connect_furniture_virtual_goods_sharing_badges_social_networking_hangout_safe_music_celebrity_celebrity_visits_cele }}" />
...
<meta name="build" content="{{ locale.community_havanaweb }}" />
</head>
...
<div id="navi2-container" class="pngbg">
    <div id="navi2" class="pngbg clearfix">
		<ul>
			<li class="selected">
				{{ locale.community_community_text }}			</li>
    		<li class="">
				<a href="{{ site.sitePath }}/articles">{{ locale.community_news }}</a>    		</li>
    		<li class="">
				<a href="{{ site.sitePath }}/tag">{{ locale.community_tags }}</a>    		</li>
    		<li class="">
				<a href="{{ site.sitePath }}/community/events">{{ locale.community_events }}</a>    		</li>
    		<li class=" last">
				<a href="{{ site.sitePath }}/community/fansites">{{ locale.community_fansites }}</a>    		</li>
    		<!-- <li class=" last">
				<a href="{{ site.sitePath }}/events/steampunk">{{ locale.community_steampunk }}</a>    		</li> -->
		</ul>
    </div>
</div>
...
<div class="box-tabs-container clearfix">
    <h2>{{ locale.community_rooms }}</h2>
    <ul class="box-tabs">
        <li id="tab-0-0-1"><a href="#">{{ locale.community_top_rated }}</a><span class="tab-spacer"></span></li>
        <li id="tab-0-0-2" class="selected"><a href="#">{{ locale.community_recommended_rooms }}</a><span class="tab-spacer"></span></li>
    </ul>
</div>
...
{% for room in recommendedRooms %}
    ...
    <span class="clearfix enter-room-link room-occupancy-{{ occupancyLevel }}" title="{{ locale.community_go_to_room }}" roomid="{{ room.getData().getId() }}">
	    <span class="room-enter">{{ locale.community_enter }} {{ site.siteName }} {{ locale.community_hotel }}</span>
		...
		<span class="room-owner">{{ locale.community_owner }} <a href="{{ site.sitePath }}/home/{{ room.getData().getOwnerName() }}">{{ room.getData().getOwnerName() }}</a></span>
    </span>
</li>
{% set num = num + 1 %}
{% endfor %}
...
{% endautoescape %}
            ...
            <div class="clearfix">
                <a href="#" class="room-toggle-more-data" id="room-toggle-more-data-h119">{{ locale.community_show_more_rooms }}</a>
            </div>
</div>
<script type="text/javascript">
L10N.put("show.more", "{{ locale.community_show_more_rooms|escape('js') }}");
L10N.put("show.less", "{{ locale.community_show_fewer_rooms|escape('js') }}");
...
<div class="box-tabs-container clearfix">
    <h2>{{ locale.community_groups }}</h2>
    <ul class="box-tabs">
        <li id="tab-0-1-1"><a href="#">{{ locale.community_hot_groups }}</a><span class="tab-spacer"></span></li>
        <li id="tab-0-1-2" class="selected"><a href="#">{{ locale.community_recent_topics }}</a><span class="tab-spacer"></span></li>
    </ul>
...
<div class="clearfix">
    <a href="#" class="discussions-toggle-more-data secondary" id="discussions-toggle-more-data-h121">{{ locale.community_show_more_discussions }}</a>
</div>
<script type="text/javascript">
L10N.put("show.more.discussions", "{{ locale.community_show_more_discussions|escape('js') }}");
L10N.put("show.less.discussions", "{{ locale.community_show_less_discussions|escape('js') }}");
var discussionMoreDataHelper = new MoreDataHelper("discussions-toggle-more-data-h121", "active-discussions-toplist-hidden-h121","discussions");
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix activehomes ">
							...
							<h2 class="title">{{ locale.community_random }} {{ site.siteName }}{{ locale.community_s_click_us }}							</h2>
...
{% for habbo in randomHabbos %}
        <div id="active-habbo-data-{{ num }}" class="active-habbo-data">
                    <div class="active-habbo-data-container">
                        ...
                        {{ site.siteName }} {{ locale.community_created_on }} {{ habbo.getCreatedAt() }}
												{% autoescape 'html' %}
...
<div id="column2" class="column">
        ...
        <div id="topstories">
	        <div class="topstory" style="background-image: url({{ article1.getLiveTopStory() }})">
	            <h4>{{ locale.community_latest_news }} </a></h4>
	            ...
	            <p>
	                <a href="{{ site.sitePath }}/articles/{{ article1.getUrl() }}">{{ locale.community_read_more_raquo }}</a>
	            </p>
	        </div>
	        <div class="topstory" style="background-image: url({{ article2.getLiveTopStory() }}); display: none">
	            ...
	            <p>
	                <a href="{{ site.sitePath }}/articles/{{ article2.getUrl() }}">{{ locale.community_read_more_raquo }}</a>
	            </p>
	        </div>
	        <div class="topstory" style="background-image: url({{ article3.getLiveTopStory() }}); display: none">
	            ...
	            <p>
	                <a href="{{ site.sitePath }}/articles/{{ article3.getUrl() }}">{{ locale.community_read_more_raquo }}</a>
	            </p>
	        </div>
            <div id="topstories-nav" style="display: none"><a href="#" class="prev">{{ locale.community_laquo_previous }}</a><span>1</span> / 3<a href="#" class="next">{{ locale.community_next_raquo }}</a></div>
        </div>
        <ul class="widelist">
            <li class="even">
            ...
            <li class="last"><a href="{{ site.sitePath }}/articles">{{ locale.community_more_news_raquo }}</a></li>
        </ul>
</div>
<script type="text/javascript">
	document.observe("dom:loaded", function() { NewsPromo.init(); });
				...
				<div class="habblet-container ">		
					<div class="cbb clearfix green ">
						<h2 class="title">{{ locale.community_tags }}							</h2>
