...
<p>
<a href="#" class="new-button" id="webstore-notes-edit"><b>{{ locale.homes_editor_go_back_to_edit }}</b><i></i></a>
<a href="#" class="new-button" id="webstore-notes-add"><b>{{ locale.homes_editor_add_note_to_page }}</b><i></i></a>
</p>
