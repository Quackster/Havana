...
<head>
	...
	<title>{{ site.siteName }}: Space Akademie Punkte</title>	
	{% else %}
	<title>{{ site.siteName }}: Nachrichten {{ ("currentArticle" is present) ? currentArticle.title : "Keine Neuigkeiten" }} </title>
	{% endif %}
...
<meta name="keywords" content="Retro, virtuell, Welt, beitreten, Gruppen, Foren, spielen, Spiele, online, Freunde, Teenager, Sammeln, soziales Netzwerk, erstellen, verbinden, Möbel, virtuell, Waren, teilen, Abzeichen, sozial, Vernetzung, Treffpunkt, Safe, Musik, Berühmtheit, Promi-Besuche" />
			...
			<div class="habblet-container ">		
				<div class="cbb clearfix default ">
						...
						{% elseif archiveView %}
							...
							{% endfor %}
						{% else %}
							{% include "habblet/news_sidebar.tpl" with { "articles": articlesToday, "header": 'Heute' } %}
							{% include "habblet/news_sidebar.tpl" with { "articles": articlesYesterday, "header": 'Gestern' } %}
							{% include "habblet/news_sidebar.tpl" with { "articles": articlesThisWeek, "header": 'Letzte Woche' } %}
							{% include "habblet/news_sidebar.tpl" with { "articles": articlesThisMonth, "header": 'Letzter Monat' } %}
							{% include "habblet/news_sidebar.tpl" with { "articles": articlesPastYear, "header": 'Dieses Jahr' } %}
						{% endif %}
						{% if (not archiveView) %}
						<a href="{{ site.sitePath }}/{{ articleLink }}/archive">Mehr Lesen &raquo;</a>
						{% endif %}		
					</div>
				</div>
			</div>
								...
								document.observe("dom:loaded", function() {
									$$('.article-images a').each(function(a) {
										Event.observe(a, 'click', function(e) {
											Event.stop(e);
											Overlay.lightbox(a.href, "Bild lädt...");
										});
									});
