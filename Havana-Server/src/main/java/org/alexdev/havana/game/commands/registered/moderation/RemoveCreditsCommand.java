...
public class RemoveCreditsCommand extends Command {
    @Override
    ...
    public void handleCommand(Entity entity, String message, String[] args) {
        ...
        CurrencyDao.decreaseCredits(targetUser, amount);
        ...
        player.send(new CHAT_MESSAGE(ChatMessageType.WHISPER, player.getRoomUser().getInstanceId(), amount + " credits removed from user " + targetUser.getName(), 0));
    }
