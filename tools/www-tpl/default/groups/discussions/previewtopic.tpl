...
<tr class="post-list-index-preview">
	<td class="post-list-row-container">
            ...
            <img alt="{{ locale.groups_discussions_online_anim }}" src="{{ site.staticContentPath }}/web-gallery/images/myhabbo/habbo_online_anim.gif" />
			{% else %}
			<img alt="{{ locale.groups_discussions_online_anim }}" src="{{ site.staticContentPath }}/web-gallery/images/myhabbo/habbo_offline.gif" />
			{% endif %}
		<div class="post-list-posts post-list-creator-info">{{ locale.groups_discussions_messages }} {{ userReplies }}</div>
		<div class="clearfix">
            ...
            <div class="post-list-avatar-badge">
				<img src="{{ site.staticContentPath }}/c_images/Badges/{{ badge }}.gif" />			
			</div>
			{% endif %}
        </div>
	...
	<td class="post-list-message" valign="top" colspan="2">
            <a href="#" id="edit-post-message" class="resume-edit-link">{{ locale.groups_discussions_laquo_edit }}</a>
        <span class="post-list-message-header"> {% autoescape 'html' %}{{ topicName }}{% endautoescape %}</span><br />
        ...
        <div>
                <div id="discussion-captcha-preview"></div>                <div class="button-area">
  		            <a id="topic-form-cancel-preview" class="new-button red-button cancel-icon" href="#"><b><span></span>{{ locale.groups_discussions_cancel }}</b><i></i></a>
		            <a id="topic-form-save-preview" class="new-button green-button save-icon" href="#"><b><span></span>{{ locale.groups_discussions_save }}</b><i></i></a>
		        </div>
        </div>
	</td>
</tr>
