...
{% if friends > 0 %}
	...
	{% endfor %}
{% else %}
{{ locale.homes_widget_you_don_t_have_any_friends }}
{% endif %}
</ul>
...
<div id="avatar-list-paging">
	...
	<br/>
		...
		<a href="#" class="avatar-list-paging-link" id="avatarlist-search-first" >{{ locale.homes_widget_first }}</a> |
		...
		<a href="#" class="avatar-list-paging-link" id="avatarlist-search-last" >{{ locale.homes_widget_last }}</a>
		{% else %}
