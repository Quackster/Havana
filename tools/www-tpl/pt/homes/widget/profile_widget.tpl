...
{% endif %}
	...
	{% endautoescape %}
				...
				<div class="profile-friend-request clearfix">
						<a class="new-button" id="add-friend" style="float: left"><b>Adicionar amigo</b><i></i></a>
					</div>
				{% endif %}
 ...
 <div style="display: block;">
  <div class="content-red">
   <div class="content-red-body">
    <span id="tag-limit-message"><img src="{{ site.staticContentPath }}/web-gallery/images/register/icon_error.gif"/> O limite é de 8 tags!</span>
    <span id="tag-invalid-message"><img src="{{ site.staticContentPath }}/web-gallery/images/register/icon_error.gif"/> Tag inválida.</span>
   </div>
  </div>
    ...
    <script type="text/javascript">
		document.observe("dom:loaded", function() {
			new ProfileWidget('{{ user.id }}', '{{ playerDetails.id }}', {
				...
				messageText: "Tem certeza que quer pedir <strong\>{{ user.getName() }}</strong\> para ser seu amigo? Pense duas vezes antes de clicar em OK!",
				loginText: "Você deve logar antes de enviar um pedido de amizade.",
				buttonText: "Ok",
