...
<head>
	...
	<title>{{ site.siteName }}: Coleccionables </title>
    ...
    <div id="column1" class="column">
				<div class="habblet-container " id="collectible-current">
						<div class="cbb clearfix gray ">
							...
							<h2 class="title">Actual coleccionable							</h2>
...
{% if session.loggedIn %}
				<a href="#" class="new-button collectibles-purchase-current"><b>Compra</b><i></i></a>
{% endif %}
				<span class="collectibles-timeleft">Disponible hasta: <span id="collectibles-timeleft-value"></span></span>
			</p>
{% else %}
		<div id="collectibles-current-img" style="background-image: url()"></div>
		<h4>No collectable</h4>
		<p>March 2019</p>
			<p class="last">Actualmente no hay coleccionable</p>
						<p id="collectibles-purchase">
...
{% endif %}
				...
				<div class="habblet-container ">
						<div class="cbb clearfix red ">
							...
							<h2 class="title">Sala de exposición coleccionable							</h2>
...
<div id="column2" class="column">
				<div class="habblet-container ">
						<div class="cbb clearfix red ">
							...
							<h2 class="title">¿Qué son los coleccionables?							</h2>
...
Los coleccionables son muebles especiales vendidos solo por un período de tiempo limitado y establecido. Los {{ site.siteName }}s experimentados los conocerían como raras.Siempre cuestan lo mismo: 200 créditos.
				...
				<div class="habblet-container ">
						<div class="cbb clearfix red ">
							...
							<h2 class="title">Invierte en coleccionables							</h2>
...
<p class="collectibles-value-intro">
	...
	¡Recoge tu camino a las riquezas!Los coleccionables no solo son una gran pieza de mobiliario, sino que también vienen con un increíble valor comercial.Como los coleccionables nunca volverán a vender por bastante tiempo (eso es una promesa), el valor seguirá aumentando en el tiempo.</p>
