<div id="badge-editor-flash">
 <p>{{ locale.groups_habblet_adobe_flash_player_is_required }}</p>
 <p><a href="http://www.adobe.com/go/getflashplayer">{{ locale.groups_habblet_click_here_to_install_adobe_flash_player }}</a>.</p>
</div>
