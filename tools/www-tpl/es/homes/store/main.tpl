...
<div id="webstore-content-container">
	<div id="webstore-items-container">
		<h4>Seleccione un elemento haciendo clic en él</h4>
...
{% if playerDetails.credits > 1 %}Tienes:<br /><b>{{ playerDetails.credits }} credits</b><br />{% else %}Tienes:<br /><b>{{ playerDetails.credits }} credit</b><br />{% endif %}
