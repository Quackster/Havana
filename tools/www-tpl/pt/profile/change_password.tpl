...
<div class="box-content">
            ...
            <ul>
				...
				{% endif %}
                </li><li class="selected">Minha Senha
    ...
    <div class="habblet-container " style="float:left; width: 560px;">
        <div class="cbb clearfix settings">
            ...
            <h2 class="title">Alterar suas configurações de senha</h2>
            <div class="box-content">
...
<p>Se alguém lhe disse para vir aqui e alterar sua senha em troca de uma recompensa, não altere sua senha!</p>
...
<p>Sua nova senha deve ter pelo menos 6 caracteres. Sua senha pode incluir letras minúsculas, MAIÚSCULAS e números.</p>

<p>
 <label for="bean_password">Nova senha</label><br /> 
...
<p>
 <label for="bean_retypedPassword">Nova senha (novamente)</label><br />
...
<a href="#" class="new-button" style="display: none" id="pwform-submit"><b>Alterar Senha</b><i></i></a>
