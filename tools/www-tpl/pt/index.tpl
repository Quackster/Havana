   ...
   <body id="frontpage">
      <div id="fp-container">
         <div id="header" class="clearfix">
            ...
            Novo aqui?
            <a href="{{ site.sitePath }}/register">REGISTRE-SE AGORA</a>
            </span>
         </div>
         <div id="content">
   ...
   <li>{{ alert.message }}</li>
                           ...
                           <form action="{{ site.sitePath }}/account/submit" method="post" class="login-habblet">
                              <ul>
                                 ...
                                 <li id="register-link" class="no-label">
                                    <a href="{{ site.sitePath }}/register" class="login-register-link"><span>Registre-se gratuitamente</span></a>
                                 </li>
                                 <li class="no-label">
                                    <a href="{{ site.sitePath }}/account/password/forgot" id="forgot-password"><span>Esqueci meu nome/senha</span></a>
                                 </li>
                              </ul>
               ...
               <div class="habblet-container ">
                  ...
                  <script type="text/javascript">
                     ...
                     var i = 0;
					sb.add("fp-bubble-"+i++, "frontpage-image", 489, 143, "Crie seu avatar...");
					sb.add("fp-bubble-"+i++, "frontpage-image", 478, 254, "...e faça novos amigos!");
					sb.add("fp-bubble-"+i++, "frontpage-image", 93, 249, "Entre na maior comunidade virtual do mundo!");
            ...
            <div id="column-footer">
               <div class="habblet-container ">
                  <div class="cbb" id="hotel-stats">
                     <ul class="stats">
                        ...
                        <li class="stats-visited"><span class="stats-fig">{{ site.visits }}</span> visitantes nos últimos 30 dias</li>
                     </ul>
                  </div>
               </div>
               <script type="text/javascript">if (!$(document.body).hasClassName('process-template')) { Rounder.init(); }</script>
               <div class="habblet-container ">
                  <div class="cbb habblet box-content" id="tag-cloud-slim">
                     <span class="tags-habbos-like">{{ site.siteName }}s Gostam de: </span>
                     <ul class="tag-list">
						{% autoescape 'html' %}
