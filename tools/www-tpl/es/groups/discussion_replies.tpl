{% if hasMessage == false %}
	<div class="postlist-header clearfix">
			...
			{% endif %}
                ...
                <a href="#" id="edit-topic-settings" class="edit-topic-settings-link">Editar Hilo &raquo;</a>
								{% endif %}
                <input type="hidden" id="settings_dialog_header" value="Editar configuración del hilo"/>
