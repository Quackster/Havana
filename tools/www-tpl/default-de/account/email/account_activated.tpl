...
<head>
	...
	<title>{{ site.siteName }}: Email Aktivierung </title>
...
<div class="cbb clearfix green">
    <h2 class="title" style="background-color: #429B00;">Email erfolgreich aktiviert!</h2>
    <div class="box-content">
        <span>
		Deine Email ist nun verifiziert.
		<br>
		<a href="{{ site.sitePath }}/">Weiter zum {{ site.siteName }} Hotel.</a>
		</span>
    </div>
</div>
{% else %}
<div class="cbb clearfix red">
    <h2 class="title">Email-Link wurde nicht erfolgreich verarbeitet.</h2>
    <div class="box-content">
        <span>
		Der Aktivierungslink war ungültig.
		<br>
		<a href="{{ site.sitePath }}/">Weiter zum {{ site.siteName }} Hotel.</a>
		</span>
    </div>
