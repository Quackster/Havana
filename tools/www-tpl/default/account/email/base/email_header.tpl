<table border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana; font-size: 13px; width: 600px;">
<tbody>
	<tr>
		<td bgcolor="#BCE0EE" height="93" style="border-bottom: 3px solid black;" valign="middle">
			<table border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana,Arial,sans-serif; font-size: 13px;">
				...
				<tr>
					<td>
						<img alt="{{ locale.account_email_habbo_logo }}" src="{{ site.emailStaticPath }}/c_images/WebLogos/habbo_logo_nourl.gif" >
					</td>
					<td>
						<a href="{{ site.sitePath }}/" target="_blank">
						<img alt="{{ locale.account_email_enter_habbo_hotel_button }}" border="0" src="{{ site.emailStaticPath }}/c_images/Enter-Habbo-Buttons/enter_en.gif">
						</a>
					</td>
				</tr>
			</tbody>
