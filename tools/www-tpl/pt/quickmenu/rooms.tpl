...
{% else %}
	<li class="odd">Você ainda não tem nenhum quarto</li>
{% endif %}
</ul>
<p class="create-room"><a href="{{ site.sitePath }}/client?shortcut=roomomatic" onclick="HabboClient.openShortcut(this, 'roomomatic'); return false;" target="client">Crie um quarto</a></p>