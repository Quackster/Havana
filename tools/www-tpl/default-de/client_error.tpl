...
<head>
	...
	<title>{{ site.siteName }}: Fehler </title>
...
<div id="column1" class="column">
    ...
    <p>Hoppla, der Client hat ein technisches Problem. Keine Sorge, der Fehler wurde nun in unserem System erfasst und wird von unserem Support-Team untersucht.</p>

    <p>Bitte öffne <a onclick="openOrFocusHabbo(this); return false;" target="client" href="{{ site.sitePath }}/client">hotel</a> erneut, um fortzufahren. Wir entschuldigen uns für die Unannehmlichkeiten.</p>
    </div>
    ...
    <div class="hotel-open">
        ...
        <div class="hotel-open-button-content">
            <a class="open" href="{{ site.sitePath }}/client" target="client" onclick="HabboClient.openOrFocus(this); return false;">Beitreten</a>
