{% if hasMessage == false %}
	<div class="postlist-header clearfix">
				...
				<span class="topic-closed"><img src="{{ site.staticContentPath }}/web-gallery/images/groups/status_closed.gif" title="Closed Thread"> Thread geschlossen</span>
			{% endif %}
				{% if canReplyForum %}
                ...
                <a href="#" id="edit-topic-settings" class="edit-topic-settings-link">Bearbeiten &raquo;</a>
								{% endif %}
                <input type="hidden" id="settings_dialog_header" value="Thread Einstellung"/>
...
{% for reply in replyList %}
	...
	<td class="post-list-message" valign="top" colspan="2"> 
		...
		<a href="#" class="quote-post-link verify-email" id="quote-post-{{ reply.getId() }}-message">Zitat</a>    
		{% endif %}
		...
		{% if (session.loggedIn) and 
				...
				(reply.isDeleted() == false) %}                  
		<a href="#" class="edit-post-link verify-email" id="edit-post-{{ reply.getId() }}-message">Ändern</a>
		{% endif %}
       ...
       <div class="post-list-report-element">
        ...
        <div class="post-list-content-element">
			...
			<span class="post-list-message-edited">Zuletzt bearbeitet: {{ reply.getEditedDate('MMM dd, yyyy') }} ({{ reply.getEditedDate('h:mm a') }})</span>
			<br/>
			{% endif %}
...
<tr id="new-post-entry-message" style="display:none;">
	...
	<td colspan="2">
        ...
        <a href="#" class="preview-post-link" id="post-form-preview">Vorschau &raquo;</a>
...
<h3>
<label for="bean_captcha" class="registration-text"Gebe den angezeigten Sicherheitscode ein.</label>
</h3>
...
<div id="new-post-preview" style="display:none;">
    ...
    <div class="postlist-footer clearfix">
				...
				{% if discussionTopic.isOpen() == false %}
				<span class="topic-closed"><img src="{{ site.staticContentPath }}/web-gallery/images/groups/status_closed.gif" title="Closed Thread"> Thread geshlossen</span>
			{% endif %}
...
L10N.put("register.error.security_code", "Ungültiger Code, bitte versuche es erneut.");
