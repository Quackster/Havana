...
public class SESSION_PARAMETERS extends PlayerMessageComposer {
    ...
    public void compose(NettyResponse response) {
        ...
        parameters.put(SessionParamType.DATE_FORMAT, "yyyy-MM-dd"); // Configures date formatting. Value is date string.
        ...
        parameters.put(SessionParamType.TUTORIAL_ENABLED, isTutorialEnabled(getPlayer()) ? "1" : "0");//GameConfiguration.getInstance().getBoolean("tutorial.enabled") ? "1" : "0"); // tutorial_enabled. Value is either 1 or 0 (enabled or disabled)
