...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de">
   <head>
      ...
      <meta name="description" content="Habbo ist eine virtuelle Welt, in der du Freunde treffen und finden kannst." />
      <meta name="keywords" content="habbo, virtuelle Welt, spiel Games, tritt Wettbewerbe bei, schließe Freundschaften" />
      <!--[if IE 8]>
   ...
   <body id="frontpage">
      <div id="fp-container">
         <div id="header" class="clearfix">
            ...
            Neu hier?
            <a href="{{ site.sitePath }}/register">Jetzt Registrieren!</a>
            </span>
         </div>
         <div id="content">
   ...
   <li>{{ alert.message }}</li>
                           ...
                           <form action="{{ site.sitePath }}/account/submit" method="post" class="login-habblet">
                              <ul>
                                 ...
                                 <li>
                                    ...
                                    <a href="#" id="login-submit-new-button" class="new-button" style="margin-left: 0;display:none"><b style="padding-left: 10px; padding-right: 7px; width: 60px">Anmelden</b><i></i></a>
                                 </li>
                              ...
                              <div id="remember-me-notification" class="bottom-bubble" style="display:none;">
                                 ...
                                 <div class="bottom-bubble-c">
                                    Wenn du Angemeldet bleiben auswählst, bleibst du auf diesem Computer angemeldet, bis du dich abmeldest. Verwende diese Funktion bitte nicht, wenn es sich um einen öffentlichen Computer handelt.
                                 </div>
               ...
               <div class="habblet-container ">
                  ...
                  <script type="text/javascript">
                     ...
                     var i = 0;
					sb.add("fp-bubble-"+i++, "frontpage-image", 489, 143, "Wer das liest ist...");
					sb.add("fp-bubble-"+i++, "frontpage-image", 478, 254, "...Dumm?!");
					sb.add("fp-bubble-"+i++, "frontpage-image", 93, 249, "Wie bin ich hier her gekommen?");
            ...
            <div id="column-footer">
               <div class="habblet-container ">
                  <div class="cbb" id="hotel-stats">
                     <ul class="stats">
                        <li class="stats-online"><span class="stats-fig">{{ site.usersOnline }}</span> {{ site.siteName }}s Online!</li>
                        <li class="stats-visited"><span class="stats-fig">{{ site.visits }}</span> in letzten 30 Tagen.</li>
                     </ul>
                  </div>
               </div>
               <script type="text/javascript">if (!$(document.body).hasClassName('process-template')) { Rounder.init(); }</script>
               <div class="habblet-container ">
                  <div class="cbb habblet box-content" id="tag-cloud-slim">
                     ...
                     <ul class="tag-list">
						...
						{% endfor %}
						{% else %}
						<li><span class="tags-habbos-like"> Retro, Habbo, Free, 2009, Best Game</span></li>
						{% endif %}
						{% endautoescape %}
                     </ul>
                  </div>
