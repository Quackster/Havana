...
<div class="w_skin_{{ sticker.getSkin() }}">
	<div class="widget-corner" id="widget-{{ sticker.getId() }}-handle">
		<div class="widget-headline"><h3>
			...
			{% endif %}
			<span class="header-left">&nbsp;</span><span class="header-middle">Gruppenmitglieder (<span id="avatar-list-size">{{ members }}</span>)</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
	<div class="widget-body">
		<div class="widget-content">
			<div id="avatar-list-search">
				...
				<a class="new-button" style="float:left;" id="avatarlist-search-button"><b>Suche</b><i></i></a>
			</div>
			<br clear="all"/>
