...
<a href="#" class="new-button" id="guestbook-form-continue"><b>{{ locale.homes_widget_continue_editing }}</b><i></i></a>
<a href="#" class="new-button" id="guestbook-form-post"><b>{{ locale.homes_widget_add_entry }}</b><i></i></a>	
</div>