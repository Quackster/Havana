...
<div class="box-content">
            ...
            <ul>
				...
				{% endif %}
                </li><li class="selected">MI CONTRASEÑA
...
<p>Si alguien te dijo que vinieras aca y cambiaras tu contraseña por una recompensa ¡No lo hagas!</p>
...
<h3>Pon tu nueva contraseña</h3>

<p>Tu nueva contraseña debe tener almenos 6 caracteres. Tu contraseña puede incluir minusculas, MAYUSCULAS, letras y numeros.</p>
...
<p>
 <label for="bean_retypedPassword">Nueva contraseña (De nuevo)</label><br />
...
<h3>
<label for="bean_captcha" class="registration-text">Escribe el codigo de seguridad que se muestra abajo.</label>
</h3>
...
<div class="register-label" id="captcha-reload">
    <p>
        ...
        <a id="captcha-reload-link" href="#">No puedo leer el codigo, dame otro.</a>
    </p>
</div>
...
<a href="#" class="new-button" style="display: none" id="pwform-submit"><b>Cambiar contraseña</b><i></i></a>
