...
<p style="font-size: 18px;"><b>Email Activation</b></p>
<p>Thanks for activating your email at <a style="color: #66b3ff" href="{{ site.sitePath }}/?email">{{ site.emailHotelName }}</a>.</p>
...
<p>Here's some other stuff you may want to do:</p>
	...
	<li style="padding-left: 30px;"><a style="color: #66b3ff" href="{{ site.sitePath }}/profile?tab=2">Change Configuraciones de la cuenta</a>.</li>
