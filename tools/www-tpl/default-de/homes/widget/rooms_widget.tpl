...
{% endif %}
		<span class="header-left">&nbsp;</span><span class="header-middle">Meine Räume</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
	<div class="widget-body">
		<div class="widget-content">
		{% if rooms|length == 0 %}
		Du hast noch keine Räume..
		{% else %}
    <div id="room_wrapper">
        	...
        	<div class="room_info">
        		...
        		<div>{% autoescape 'html' %}{{ room.getData().getDescription() }}{% endautoescape %}        		</div>
					<a href="{{ site.sitePath }}/client?forwardId=2&amp;roomId={{ room.getId() }}"
					    ...
					    onclick="HabboClient.roomForward(this, '{{ room.getId() }}', 'private', false); return false;">					 Beitreten..					 </a>        	</div>
		<br class="clear" />
