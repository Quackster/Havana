	...
	<div id="header" class="clearfix">
       ...
       <div id="subnavi">
            <div id="subnavi-user">
                ...
                <p>
				        <a href="{{ site.sitePath }}/client" id="enter-hotel-open-medium-link" target="client" onclick="HabboClient.openOrFocus(this); return false;">Ingresse {{ site.siteName }} Hotel</a>
                </p>
            </div>
            <div id="subnavi-login">
                <form action="{{ site.sitePath }}/account/submit" method="post" id="login-form">
                    ...
                    <ul>
                        <li>
                            <label for="login-username" class="login-text"><b>Nombre de usuario</b></label>
                ...
                <div id="subnavi-login-help" class="clearfix">
                    <ul>
                        <li class="register"><a href="{{ site.sitePath }}/account/password/forgot" id="forgot-password"><span>Olvidé mi contraseña/nombre de usuario</span></a></li>
...
<div id="remember-me-notification" class="bottom-bubble" style="display:none;">
	...
	<div class="bottom-bubble-c">
					Al seleccionar "recuerdame", permanecerá conectado en esta computadora hasta que haga clic en "Cerrar sesión". Si se trata de una computadora pública, no utilice esta función.	</div>
	<div class="bottom-bubble-b"><div></div></div>
		...
		<ul id="navi">
			...
			<li class="selected">
				<strong>Monedas</strong>			<span></span>
			</li>
			{% else %}
			<li>
        ...
        <div id="habbos-online"><div class="rounded"><span>{{ site.formattedUsersOnline }} {{ site.siteName }}s en línea</span></div></div>
	</div>
</div>
       ...
       <div id="subnavi">
            ...
            <div id="subnavi-search">
                ...
                <ul id="subnavi-search-links">
					...
					<li><a href="{{ site.sitePath }}/account/logout" class="userlink" id="signout">Desconectar</a></li>
				</ul>
                </div>
            </div>
            <div id="to-hotel">
                        {% if site.serverOnline %}
						<a href="{{ site.sitePath }}/client" class="new-button green-button" target="client" onclick="HabboClient.openOrFocus(this); return false;"><b>Ingresse {{ site.siteName }} 
                        Hotel</b><i></i></a>
                        {% else %}
                        <div id="hotel-closed-medium">{{ site.siteName }} Hotel fuera de linea</div>
                        {% endif %}
			</div>
        </div>
		<script type="text/javascript">
		...
		<ul id="navi">
			...
			{% if playerDetails.getRank().getRankId() >= 6 %}
				<li id="tab-register-now"><a href="{{ site.sitePath }}/allseeingeye/hk/">Gestor de sitio web</a><span></span></li>
			{% endif %}
