...
<head>
	...
	<title>{{ site.siteName }}: Comunidad </title>
...
<div class="box-tabs-container clearfix">
    <h2>Habitaciones</h2>
    <ul class="box-tabs">
        <li id="tab-0-0-1"><a href="#">Los más valorados</a><span class="tab-spacer"></span></li>
        <li id="tab-0-0-2" class="selected"><a href="#">Recomendadas</a><span class="tab-spacer"></span></li>
    </ul>
</div>
...
{% for room in recommendedRooms %}
    ...
    <span class="clearfix enter-room-link room-occupancy-{{ occupancyLevel }}" title="Go to room" roomid="{{ room.getData().getId() }}">
	    <span class="room-enter">Ingrese el {{ site.siteName }} Hotel</span>
		...
		<span class="room-owner">Dueño: <a href="{{ site.sitePath }}/home/{{ room.getData().getOwnerName() }}">{{ room.getData().getOwnerName() }}</a></span>
    </span>
</li>
{% set num = num + 1 %}
{% endfor %}
...
{% for room in hiddenRecommendedRooms %}
    ...
    <span class="clearfix enter-room-link room-occupancy-{{ occupancyLevel }}" title="Ir a la habitación" roomid="{{ room.getData().getId() }}">
	    <span class="room-enter">Ingrese el {{ site.siteName }} Hotel</span>
	    <span class="room-name">{% autoescape 'html' %}{{ room.getData().getName() }}{% endautoescape %}</span>
	    <span class="room-description">{% autoescape 'html' %}{{ room.getData().getDescription() }}{% endautoescape %}</span>
		<span class="room-owner">Dueño: <a href="{{ site.sitePath }}/home/{{ room.getData().getOwnerName() }}">{{ room.getData().getOwnerName() }}</a></span>
...
{% endautoescape %}
            ...
            <div class="clearfix">
                <a href="#" class="room-toggle-more-data" id="room-toggle-more-data-h119">Mostrar más habitaciones</a>
            </div>
</div>
<script type="text/javascript">
L10N.put("show.more", "Mostrar más habitaciones");
L10N.put("show.less", "Mostrar menos habitaciones");
...
<div class="box-tabs-container clearfix">
    ...
    <ul class="box-tabs">
        ...
        <li id="tab-0-1-2" class="selected"><a href="#">Temas Recientes</a><span class="tab-spacer"></span></li>
    </ul>
...
<div class="clearfix">
    <a href="#" class="discussions-toggle-more-data secondary" id="discussions-toggle-more-data-h121">Mostrar más discusiones</a>
</div>
<script type="text/javascript">
...
var discussionMoreDataHelper = new MoreDataHelper("discussions-toggle-more-data-h121", "active-discussions-toplist-hidden-h121","discussions");
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix activehomes ">
							...
							<h2 class="title">{{ site.siteName }}s aleatorios - ¡Haz clic en nosotros!							</h2>
