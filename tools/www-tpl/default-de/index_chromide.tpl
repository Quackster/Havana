   ...
   <body id="frontpage">
      <div id="fp-container">
         <div id="header" class="clearfix">
            ...
            New here?
            <a href="{{ site.sitePath }}/register">Kostenlos Registrieren</a>
            </span>
         </div>
         <div id="content">
                           ...
                           <form action="{{ site.sitePath }}/account/submit" method="post" class="login-habblet">
                              ...
                              <div id="remember-me-notification" class="bottom-bubble" style="display:none;">
                                 ...
                                 <div class="bottom-bubble-c">
                                    Wenn du Angemeldet bleiben auswählst, bleibst du auf diesem Computer angemeldet, bis du auf 'Abmelden' klickst. Verwende diese Funktion bitte nicht, wenn es sich um einen öffentlichen Computer handelt.
                                 </div>
