...
<div id="hotgroups-habblet-list-container" class="habblet-list-container groups-list">
    ...
    <div class="clearfix">
        <a href="#" class="hotgroups-toggle-more-data secondary" id="hotgroups-toggle-more-data-h122">Zeige mehr Gruppen</a>
    </div>
<script type="text/javascript">
L10N.put("show.more.groups", "Zeige mehr");
L10N.put("show.less.groups", "Zeige weniger");
