...
{% if groups|length > 0 %}
		...
		<li class="{{ status }}">
			...
			{% if group.isMember(playerDetails.id) %}
				...
				{% if member.getMemberRank().getRankId() == 3 %}
					<div class="owned-group" title="Besitzer"></div>
				{% endif %}
			...
			<div class="favourite-group" title="Favorit"></div>
			{% endif %}
	...
	{% endfor %}
{% else %}
	<li class="odd">Du gehörst keiner Gruppe an..</li>
{% endif %}
<p class="create-group"><a href="#" onclick="GroupPurchase.open(); return false;">Gruppe gründen</a></p>