...
<head>
    ...
    <title>{{ site.siteName }}{{ locale.client_flash_hotel }}</title>
    ...
    <script type="text/javascript">
        ...
        var flashvars = {
            ...
            "account_id": "1",
            "client.starting": "{{ locale.client_flash_hotel_is_loading_please_wait|escape('js') }}",
            ...
            <div id="flash-container">
                <div id="content" style="width: 400px; margin: 20px auto 0 auto;">
                    <div class="cbb clearfix">
                        <h2 class="title">{{ locale.client_flash_please_update_your_flash_player_to_the_latest_version }}</h2>
						<div class="box-content">
							<p>{{ locale.client_flash_you_can_install_and_download_adobe_flash_player_here }} <a href="http://get.adobe.com/flashplayer/">{{ locale.client_flash_install_flash_player }}</a>{{ locale.client_flash_more_instructions_for_installation_can_be_found_here }} <a href="http://www.adobe.com/products/flashplayer/productinfo/instructions/">{{ locale.client_flash_more_information }}</a></p>
							<p><a href="http://www.adobe.com/go/getflashplayer"><img src="http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="{{ locale.client_flash_get_adobe_flash_player }}" /></a></p>
						</div>
                    </div>
                </div>
                <noscript>
					<div style="width: 400px; margin: 20px auto 0 auto; text-align: center">
						<p>{{ locale.client_flash_if_you_are_not_automatically_redirected_please }} <a href="/client/nojs">{{ locale.client_flash_click_here }}</a></p>
					</div>
                </noscript>
            </div>
        </div>
