...
<div class="box-tabs-container box-tabs-left clearfix">
	...
	{% if user.id == playerDetails.id %}
	{% if editMode == false %}
	<a href="{{ site.sitePath }}/myhabbo/startSession/{{ user.id }}" id="edit-button" class="new-button dark-button edit-icon" style="float:left"><b><span></span>Basteln</b><i></i></a>
	{% endif %}
	{% endif %}
	{% endif %}
	...
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><h2><p style="color:#9D9D9D">Ich bin die Krankheit, ich bin der Schmerz...</p></h2></div>
...
<div class="movable stickie n_skin_nakedskin-c" style=" left: 73px; top: 121px; z-index: 7;" id="stickie-3188552">
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><h2><p style="color:#FFFFFF">...Ich bin der Tod, der niemals stirbt....</p></h2></div>
				<div class="stickie-footer">
				</div>
			</div>
		</div>
...
<div class="movable stickie n_skin_nakedskin-c" style=" left: 315px; top: 660px; z-index: 8;" id="stickie-3188551">
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><h1><p style="color:#007400">...an Halloween werde ich zum Spielen kommen...</p></h1></div>
				<div class="stickie-footer">
				</div>
			</div>
		</div>
...
<div class="movable stickie n_skin_nakedskin-c" style=" left: 425px; top: 55px; z-index: 6;">
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><p style="color:#FFFFFF">...mein Leben ging im Virenregen verloren...</p></div>
				<div class="stickie-footer">
				</div>
			</div>
		</div>
...
<div class="movable stickie n_skin_nakedskin-c" style=" left: 220px; top: 85px; z-index: 9;">
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><h3><p style="color:#727272">...Ich bin der Arme, der weint...</p></h3></div>
				<div class="stickie-footer">
				</div>
			</div>
		</div>
			...
			{% endif %}
				...
				<div id="edit-menu-gb-availability">
					<select id="guestbook-privacy-options">
						<option value="private"{% if (editMode == true) and (guestbookSetting == "private") %} selected{% endif %}>Nur für Freunde</option>
						<option value="public"{% if (editMode == true) and (guestbookSetting == "public") %} selected{% endif %}>Öffentlich</option>
					</select>
				</div>
...
<div id="group-memberlist-members-buttons" class="clearfix">
	...
	<a href="#" class="new-button group-memberlist-button-disabled" id="group-memberlist-button-revoke-rights"><b>Rechte nehmen</b><i></i></a>
