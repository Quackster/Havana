...
<div class="box-tabs-container clearfix">
    <h2>Räume</h2>
    <ul class="box-tabs">
        <li id="tab-0-0-1"><a href="#">Top Wertung</a><span class="tab-spacer"></span></li>
        <li id="tab-0-0-2" class="selected"><a href="#">Empfohlene Räume</a><span class="tab-spacer"></span></li>
    </ul>
</div>
...
{% for room in recommendedRooms %}
    ...
    <span class="clearfix enter-room-link room-occupancy-{{ occupancyLevel }}" title="Go to room" roomid="{{ room.getData().getId() }}">
	    <span class="room-enter">{{ site.siteName }} Hotel beitreten</span>
...
{% for room in hiddenRecommendedRooms %}
    ...
    <span class="clearfix enter-room-link room-occupancy-{{ occupancyLevel }}" title="Go to room" roomid="{{ room.getData().getId() }}">
	    ...
	    <span class="room-name">{% autoescape 'html' %}{{ room.getData().getName() }}{% endautoescape %}</span>
	    <span class="room-description">{% autoescape 'html' %}{{ room.getData().getDescription() }}{% endautoescape %}</span>
		<span class="room-owner">Besitzer: <a href="{{ site.sitePath }}/home/{{ room.getData().getOwnerName() }}">{{ room.getData().getOwnerName() }}</a></span>
    </span>
</li>
...
{% endautoescape %}
            ...
            <div class="clearfix">
                <a href="#" class="room-toggle-more-data" id="room-toggle-more-data-h119">Zeige mehr Räume</a>
            </div>
</div>
<script type="text/javascript">
L10N.put("show.more", "Zeige mehr Räume");
L10N.put("show.less", "Zeige weniger Räume");
...
<div class="box-tabs-container clearfix">
    <h2>Gruppen</h2>
    <ul class="box-tabs">
        <li id="tab-0-1-1"><a href="#">Top Gruppen</a><span class="tab-spacer"></span></li>
        <li id="tab-0-1-2" class="selected"><a href="#">Aktuelle Themen</a><span class="tab-spacer"></span></li>
    </ul>
...
<div class="clearfix">
    <a href="#" class="discussions-toggle-more-data secondary" id="discussions-toggle-more-data-h121">Zeige mehr Gespräche</a>
</div>
<script type="text/javascript">
L10N.put("show.more.discussions", "Zeige mehr Gespräche");
L10N.put("show.less.discussions", "Zeige weniger Gespräche");
var discussionMoreDataHelper = new MoreDataHelper("discussions-toggle-more-data-h121", "active-discussions-toplist-hidden-h121","discussions");
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix activehomes ">
							...
							<h2 class="title">Zufällige {{ site.siteName }}s - Klick uns!							</h2>
...
{% for habbo in randomHabbos %}
        <div id="active-habbo-data-{{ num }}" class="active-habbo-data">
                    <div class="active-habbo-data-container">
                        ...
                        {{ site.siteName }} Erstellt am: {{ habbo.getCreatedAt() }}
												{% autoescape 'html' %}
