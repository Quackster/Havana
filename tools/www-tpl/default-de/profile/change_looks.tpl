...
<div class="box-content">
            ...
            <ul>
		<li class="selected">Meine Kleidung
...
<h2 class="title">Ändere dein Outfit</h2>
<div class="box-content">
...
Um deinen {{ site.siteName }}-Charakter bearbeiten zu können, muss ein Flash-Player auf deinem Computer installiert sein. Du kannst den Player hier herunterladen: <a target="_blank" href="http://www.adobe.com/go/getflashplayer">http://www.adobe.com/go/getflashplayer</a>
</div>
...
{% endif %}
L10N.put("profile.figure.wardrobe_replace.title", "Tauschen?");
L10N.put("profile.figure.wardrobe_replace.dialog", "<p\>\nMöchtest du das gespeicherte Outfit wirklich durch das neue ersetzen?\n</p\>\n\n<p\>\n<a href=\"#\" class=\"new-button\" id=\"wardrobe-replace-cancel\"\><b\>Abbrechen</b\><i\></i\></a\>\n<a href=\"#\" class=\"new-button\" id=\"wardrobe-replace-ok\"\><b\>OK</b\><i\></i\></a\>\n</p\>\n\n<div class=\"clear\"\></div\>\n");
L10N.put("profile.figure.wardrobe_invalid_data", "Fehler! Dieses Outfit kann nicht gespeichert werden.");
L10N.put("profile.figure.wardrobe_instructions", "Drücke die roten Pfeile, um bis zu 5 Outfits in deiner Garderobe zu speichern. Drücke den grünen Pfeil, um ein Outfit auszuwählen und die Änderung zu speichern.");
Wardrobe.init();
</script>
</div>
{% endif %}
...
Artikel mit dem {{ site.siteName }} Club Symbol <img src="{{ site.staticContentPath }}/web-gallery/v2/images/habboclub/hc_mini.png" /> sind nur für {{ site.siteName }} Club Mitglieder verfügbar. <a href="{{ site.sitePath }}/club">Trete bei!</a>
	</div>
</div>

<div id="settings-oldfigure" style="display: none">
	<div class="rounded rounded-lightbrown clearfix">
Dein {{ site.siteName }} enthielt Kleidungsstücke oder Farben, die nicht mehr auswählbar sind. Bitte speichere deine neuen Looks hier.	</div>
</div>
...
<a href="#" id="settings-submit" class="new-button disabled-button"><b>Änderung speichern</b><i></i></a>
