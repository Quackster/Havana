...
<meta name="description" content="Participe do maior ponto de encontro virtual do mundo onde você pode conhecer e fazer amigos. Projete seus próprios quartos, colecione móveis legais, dê festas e muito mais! Crie o seu Habbo {{ site.siteName }} GRÁTIS hoje!" />
...
<div class="box-content">
    ...
    <div class="habblet-container " style="float:left; width: 560px;">
        <div class="cbb clearfix settings">
            ...
            <h2 class="title">Mude suas configurações de Email</h2>
            <div class="box-content">
...
<h3>You haven't confirmed that your email is valid!</h3>

<p class="last">
How to activate my account and confirm my email? Click the button and send a confirmation email to your email account. Click the link from the email message and you are done! Click the button below if you want us to send you another account activation message.</p>

<div class="settings-buttons">
<a href="#" class="new-button" style="display: none" id="confirmform-submit"><b>Activate my email-address</b><i></i></a>
...
<h3>Digite o seu endereço de email</h3>

<p>Certifique-se de digitar seu endereço de e-mail corretamente. O link de verificação de e-mail é enviado para esse endereço.</p>
...
<p>
 <input name="directemail" id="directemail"  type="checkbox"> <label for="directemail">Sim! Quero que as últimas notícias do hotel sejam enviadas diretamente para minha caixa de entrada.</label>
</p>
...
<h3>
<label for="bean_captcha" class="registration-text">Digite o código de segurança mostrado na imagem abaixo.</label>
</h3>
...
<div class="register-label" id="captcha-reload">
    <p>
        ...
        <a id="captcha-reload-link" href="#">Não consigo ler o código, crie outro.</a>
    </p>
</div>
...
<div class="settings-buttons">
<a href="#" class="new-button" style="display: none" id="emailform-submit"><b>Salvar alterações</b><i></i></a>
