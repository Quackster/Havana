...
<div class="box-content">
            ...
            <ul>
                ...
                </li><li class="selected">{% if accountActivated %}EMAIL Y VERIFICACIÓN{% else %}Email Changing & Verification{% endif %}
    ...
    <div class="habblet-container " style="float:left; width: 560px;">
        <div class="cbb clearfix settings">
            ...
            <h2 class="title">Cambia tu Email</h2>
            <div class="box-content">
...
<h3>Coloca tus datos actuales </h3>
...
<h3>Ingresa tu nuevo email</h3>

<p>Confirma que la dirección de email nueva sea correcta, el correo de verificación sera enviado ahi.</p>
...
<p>
 <input name="directemail" id="directemail"  type="checkbox"> <label for="directemail">Quiero recibir las últimas noticias de {{ site.SiteName }} Hotel</label>
</p>
...
<h3>
<label for="bean_captcha" class="registration-text">Ingresa el codigo de seguridad mostrado abajo.</label>
</h3>
...
<div class="register-label" id="captcha-reload">
    <p>
        ...
        <a id="captcha-reload-link" href="#">No puedo leer el codigo, dame un nuevo.</a>
    </p>
</div>
...
<div class="settings-buttons">
<a href="#" class="new-button" style="display: none" id="emailform-submit"><b>Salvar cambios</b><i></i></a>
