...
<head>
	...
	{% else %}
	<title>{{ site.siteName }}: Notícias ~ {{ ("currentArticle" is present) ? currentArticle.title : "Sem Notícias" }} </title>
	{% endif %}
...
<meta name="description" content="Participe do maior ponto de encontro virtual do mundo onde você pode conhecer e fazer amigos. Projete seus próprios quartos, colecione móveis legais, dê festas e muito mais! Crie seu Retro GRATUITO hoje!" />
<meta name="keywords" content="Retro, virtual, mundo, participar, grupos, fóruns, jogar, jogos, on-line, amigos, adolescentes, colecionar, rede social, criar, colecionar, conectar, móveis, virtual, bens, compartilhamento, emblemas, social, rede, hangout, seguro , música, celebridade, visitas de celebridades" />
		...
		<div id="column1" class="column">     		
			<div class="habblet-container ">		
				<div class="cbb clearfix default ">
						...
						{% endif %}
						{% if (not archiveView) %}
						<a href="{{ site.sitePath }}/{{ articleLink }}/archive">Mais notícias &raquo;</a>
						{% endif %}		
					</div>
				</div>
			</div>
