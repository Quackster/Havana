...
<span class="header-left">&nbsp;</span><span class="header-middle">Gruppeninfo</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
...
<p>Gruppe gegründet: <b>{{ group.getCreatedDate() }}</b></p>
<p>{{ sticker.getMembersAmount() }}</b> Mitglieder</p>
...
<div id="profile-tags-status-field">
    ...
    <span id="tag-limit-message"><img src="{{ site.staticContentPath }}/web-gallery/images/register/icon_error.gif"/> Das Limit sind 20 tags!</span>
