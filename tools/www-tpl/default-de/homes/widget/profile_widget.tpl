...
{% endif %}
		<span class="header-left">&nbsp;</span><span class="header-middle">Mein Profil</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
	...
	{% endautoescape %}
				...
				<div class="profile-friend-request clearfix">
						<a class="new-button" id="add-friend" style="float: left"><b>Freunde werden</b><i></i></a>
					</div>
				{% endif %}
...
<div style="display: block;">
    <div class="content-red">
    	<div class="content-red-body">
    		<span id="tag-limit-message"><img src="{{ site.staticContentPath }}/web-gallery/images/register/icon_error.gif"/> Das Limit sind 8 tags!</span>
    		<span id="tag-invalid-message"><img src="{{ site.staticContentPath }}/web-gallery/images/register/icon_error.gif"/> Ungültiger tag.</span>
		</div>
    </div>
	<div class="content-red-bottom">
    	<div class="content-red-bottom-body"></div>
            ...
            <a href="#" class="new-button" style="float:left;margin:5px 0 0 0;" id="profile-add-tag"><b>Taggen</b><i></i></a>
        </div>{% endif %}{% endif %}
    </div>
	{% if session.loggedIn %}
    <script type="text/javascript">
		document.observe("dom:loaded", function() {
			new ProfileWidget('{{ user.id }}', '{{ playerDetails.id }}', {
				headerText: "Anfrage senden?",
				messageText: "Bist du sicher, dass du <strong\>{{ user.getName() }}</strong\> fragen möchtest, dein Freund zu sein? Überlege es dir zweimal, bevor du auf OK klickst..",
				loginText: "Du musst dich anmelden, bevor du eine Freundschaftsanfrage senden kannst.",
				buttonText: "Ok",
