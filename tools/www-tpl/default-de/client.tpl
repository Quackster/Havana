...
{{ site.formattedUsersOnline }} Habbos Online</div>
...
<div class="logout"><a href="{{ site.sitePath }}/account/logout?origin=popup" onclick="self.close(); return false;">Schließen</a></div>
</div>
<noscript>
...
<div id="clientembed-loader" class="loader-image" style="display:none">
    <div class="loader-image-inner">
        <b class="loading-text">Lädt.. {{ site.siteName }}...</b>
    </div>
</div>
<div id="clientembed">
