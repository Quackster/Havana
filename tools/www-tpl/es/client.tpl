...
{{ site.formattedUsersOnline }} miembros en línea</div>
  ...
  <div class="logout"><a href="{{ site.sitePath }}/account/logout?origin=popup" onclick="self.close(); return false;">Cerrar Hotel</a></div>
</div>
<noscript>
...
<div id="clientembed-loader" class="loader-image" style="display:none">
    <div class="loader-image-inner">
        <b class="loading-text">Cargando {{ site.siteName }}...</b>
    </div>
</div>
<div id="clientembed">
...
HabboClientUtils.showLoader(["Cargando {{ site.siteName }}", "Cargando {{ site.siteName }}.", "Cargando {{ site.siteName }}..", "Cargando {{ site.siteName }}..."]);
</script>
