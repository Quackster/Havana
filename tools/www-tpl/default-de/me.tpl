...
<head>
	...
	<title>{{ site.siteName }}: Start </title>
...
<div id="container">
	<div id="content">
		...
		<!-- <div class="rounded" style="background-color: red; color: white">
			...
			Dieser Server befindet sich derzeit in der Beta-Phase. Das bedeutet, dass möglicherweise einige unvollständige Funktionen, Fehler und andere Bugs auftauchen können.<br />
		</div>
		<br /> -->
    ...
    <div class="enter-hotel-btn">
        <div class="open enter-btn">
            <a href="{{ site.sitePath }}/shockwave_client" target="shockwave_client" onclick="openOrFocusHabbo(this); return false;">Beitreten<i></i></a>
            <b></b>
        </div>
    </div>
    ...
    <div class="enter-beta-btn">
        <div class="open enter-btn">
            <a href="{{ site.sitePath }}/flash_client" target="flash_client" onclick="openOrFocusHabbo(this); return false;">{{ site.siteName }} Flash<i></i></a>
            <b></b>
        </div>
    </div>
	{% else %}
	<div class="enter-hotel-btn">
		<div class="closed enter-btn">
			<span>{{ site.siteName }} ist Offline</span>
			<b></b>
		</div>
	</div>
	{% endif %}
	...
	<div id="habbo-info">
		<div id="motto-container" class="clearfix">
			...
			<div>
				...
				<span title="Click to enter your motto/ status">Status eingeben..</span>
				{% else %}
		...
		<div id="motto-links" style="display: none"><a href="#" id="motto-cancel">Abbrechen</a></div>
	</div>

	<ul id="link-bar" class="clearfix">
        <li class="change-looks"><a href="{{ site.sitePath }}/profile">Garderobe &raquo;</a></li>
        <li class="credits">
            <a href="{{ site.sitePath }}/credits">{{ playerDetails.credits }}</a> Münzen		</li>
        <li class="club">
            {% if playerDetails.hasClubSubscription() %}
            <a href="{{ site.sitePath }}/club">{{ hcDays }} </a>Tage		</li>
            {% else %}
            <a href="{{ site.sitePath }}/club">{{ site.siteName }} Club beitreten &raquo;</a>		</li>
            {% endif %}
        <li class="activitypoints">
            <a href="{{ site.sitePath }}/credits/pixels">{{ playerDetails.pixels }}</a> Pixel		    </li>
    </ul>
    ...
    <div id="habbo-feed">
		...
		{% for alert in alerts %}	
			...
			<li id="feed-item-hc-reminder">
				<a href="#" class="remove-feed-item" id="remove-hc-reminder" title="Remove notification">Benachrichtigung entfernen</a>

				<div>Dein Habbo Club ist abgelaufen. Möchtest du deine Mitgliedschaft verlängern? </div>
				<div class="clearfix">
					<table width="100px" style="margin-top:6px; margin-left:-12px">
						<tr>
							<td>
								<a class="new-button" id="subscribe1" href="#" onclick='habboclub.buttonClick(1, "Habbo Club"); return false;'><b>1 Monat</b><i></i></a>
							</td>
							<td>
								<a class="new-button" id="subscribe2" href="#" onclick='habboclub.buttonClick(2, "Habbo Club"); return false;' style="margin-left:6px"><b>2 Monate</b><i></i></a>
							</td>
							<td>
								<a class="new-button" id="subscribe2" href="#" onclick='habboclub.buttonClick(3, "Habbo Club"); return false;' style="margin-left:6px"><b>3 Monate</b><i></i></a>
							</td>
						</tr>
					</table>
				</div>
			...
			<li id="feed-item-dailygift" class="contributed">
				<a href="#" class="remove-feed-item" title="Remove notification">Benachrichtigung entfernen</a>
		...
		{% endfor %}
			...
			<li id="feed-notification">
				Du hast <a href="{{ site.sitePath }}/client" onclick="HabboClient.openOrFocus(this); return false;">{{ feedFriendRequests }} Freundschaftsanfrage(n)</a>
			</li>
			{% endif %}
			...
			<li id="feed-friends">
			You have {{ feedFriendsOnline|length }} Freunde Online
			<span>
			...
			Du hast <a href="{{ site.sitePath }}/home/{{ playerDetails.getName() }}">{{ unreadGuestbookMessages }} neue Gästebuch Einträge</a>
			</li>
			{% endif %}
			...
			<strong>{{ pendingMembers }}</strong> deiner Gruppen haben ausstehende Mitglieder:
			<span>
			...
			<strong>{{ newPostsAmount }}</strong> deiner Gruppen haben neue Forennachrichten:
			<span>
			...
			{% if playerDetails.isTradeEnabled() %}
				<li class="small" id="feed-trading-enabled">Tausch ist aktiviert. <a href="{{ site.sitePath }}/profile?tab=6" title="">Ausschalten</a></li>
			{% else %}
				<li class="small" id="feed-trading-disabled">Tausch ist deaktiviert. <a href="{{ site.sitePath }}/profile?tab=6" title="">Anschalten</a></li>
			{% endif %}
			<!-- <li class="small" id="feed-flashbeta-invites">Dieser Server befindet sich derzeit in der Beta-Phase. Das bedeutet, dass möglicherweise einige unvollständige Funktionen, Fehler und andere Bugs auftauchen können.</li> -->
...
<script type="text/javascript">
    HabboView.add(function() {
        L10N.put("personal_info.motto_editor.spamming", "Spam nicht, Brudi!");
        PersonalInfo.init("");
    });
</script>
              ...
              <div class="cbb clearfix rooms">
                <h2 class="title">
                  ...
                  <span class="habblet-close" id="habblet-close-roomselection" onclick="RoomSelectionHabblet.showConfirmation()"></span>
                    ...
                    Huhu! Du hast noch kein vordekoriertes Zimmer mit kostenlosen Möbeln ausgewählt! Wähle unten eines aus:
                    </div>
                        <ul id="roomselection-plp" class="clearfix">
                            <li class="top">
                            <a class="roomselection-select new-button green-button" href="client?createRoom=0" target="client" onclick="return RoomSelectionHabblet.create(this, 0);"><b>Wählen</b><i></i></a>	
                            </li>
                            <li class="top">
                            <a class="roomselection-select new-button green-button" href="client?createRoom=1" target="client" onclick="return RoomSelectionHabblet.create(this, 1);"><b>Wählen</b><i></i></a>	
                            </li>
                            <li class="top">
                            <a class="roomselection-select new-button green-button" href="client?createRoom=2" target="client" onclick="return RoomSelectionHabblet.create(this, 2);"><b>Wählen</b><i></i></a>	
                            </li>
                            <li class="bottom">
                            <a class="roomselection-select new-button green-button" href="client?createRoom=3" target="client" onclick="return RoomSelectionHabblet.create(this, 3);"><b>Wählen</b><i></i></a>	
                            </li>
                            <li class="bottom">
                            <a class="roomselection-select new-button green-button" href="client?createRoom=4" target="client" onclick="return RoomSelectionHabblet.create(this, 4);"><b>Wählen</b><i></i></a>	
                            </li>
                            <li class="bottom">
                            <a class="roomselection-select new-button green-button" href="client?createRoom=5" target="client" onclick="return RoomSelectionHabblet.create(this, 5);"><b>Wählen</b><i></i></a>	
                            </li>
                        </ul>
                        <script type="text/javascript">
                        L10N.put("roomselection.hide.title", "Zimmerauswahl ausblenden");
                        L10N.put("roomselection.old_user.done", "Und fertig! Habbo Hotel öffnet sich nun in einem neuen Fenster und du wirst in kürzester Zeit zu deinem Zimmer weitergeleitet!");
              ...
              <div class="habblet-container " id="giftqueue">
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix orange ">
							...
							<h2 class="title">Heiße Neuigkeiten!							</h2>
    ...
    <ul id="hotcampaigns-habblet-list">
        ...
        <li class="even">
            <div class="hotcampaign-container">
                ...
                <h3>Im Aufbau..</h3>
                <p>Hier kannst du interesannte Nachrichten hinterlassen! :)</p>
                <p class="link"><a href="{{ site.sitePath }}">Mehr lesen &raquo;</a></p>
            </div>
        </li>
        ...
        <li class="odd">
            <div class="hotcampaign-container">
                ...
                <h3>Ebenfalls im Aufbau..</h3>
                <p>Auch hier kannst du tolle Storys erzählen..! :)</p>
                <p class="link"><a href="{{ site.sitePath }}">Mehr lesen &raquo;</a></p>
            </div>
        </li>
        ...
        <li class="odd">
            <div class="hotcampaign-container">
                ...
                <h3>Exklusive Möbel!</h3>
                <p>Trete noch heute dem Habbo Club bei und erhalte Zugang zu exklusiven Möbeln!</p>

                <p class="link"><a href="https://classichabbo.com/credits/club">Mehr lesen &raquo;</a></p>
            </div>
        </li>
        -->
    </ul>
...
<div class="habblet-container minimail" id="mail">
                        <div class="cbb clearfix blue ">
                            ...
                            <h2 class="title">Meine Nachrichten                            </h2>
                        <div id="minimail">
	    ...
	    <form style="display: none" id="message-compose">
	        ...
	        <div id="message-recipients-container" class="input-text" style="width: 426px; margin-bottom: 1em">
	        	...
	        	<div class="autocomplete" id="message-recipients-auto">
	        		<div class="default" style="display: none;">Gib den Namen eines Freundes ein</div>
	        ...
	        <div class="new-buttons clearfix">
	            ...
	            <a href="#" class="new-button send"><b>Senden</b><i></i></a>
	        </div>
	    </form>
	</div>
				<script type="text/javascript">
		L10N.put("minimail.compose", "Schreiben").put("minimail.cancel", "Abbrechen")
			.put("bbcode.colors.red", "Rot").put("bbcode.colors.orange", "Orange")
	    	.put("bbcode.colors.yellow", "Gelb").put("bbcode.colors.green", "Grün")
	    	.put("bbcode.colors.cyan", "Cyan").put("bbcode.colors.blue", "Blau")
	    	.put("bbcode.colors.gray", "Grau").put("bbcode.colors.black", "Schwarz")
	    	.put("minimail.empty_body.confirm", "Sicher, dass du die Nachricht so absenden willst?")
	    	.put("bbcode.colors.label", "Farbe").put("linktool.find.label", " ")
	    	.put("linktool.scope.habbos", "{{ site.siteName }}s").put("linktool.scope.rooms", "Räume")
	    	.put("linktool.scope.groups", "Gruppen").put("minimail.report.title", "Nachricht an Moderator melden");

	    L10N.put("date.pretty.just_now", "jetzt grade");
	    L10N.put("date.pretty.one_minute_ago", "1 Minute zuvor");
	    L10N.put("date.pretty.minutes_ago", "{0} Minuten zuvor");
	    L10N.put("date.pretty.one_hour_ago", "1 Stunde zuvor");
	    L10N.put("date.pretty.hours_ago", "{0} Stunden zuvor");
	    L10N.put("date.pretty.yesterday", "gestern");
	    L10N.put("date.pretty.days_ago", "{0} Tage zuvor");
	    L10N.put("date.pretty.one_week_ago", "1 Woche zuvor");
	    L10N.put("date.pretty.weeks_ago", "{0} Wochen zuvor");
...
<div class="box-tabs-container clearfix">
    ...
    <ul class="box-tabs">
        <li id="tab-0-4-1"><a href="#">Suche {{ site.siteName }}s</a><span class="tab-spacer"></span></li>

        <li id="tab-0-4-2" class="selected"><a href="#">Freunde einladen</a><span class="tab-spacer"></span></li>
    </ul>
</div>
    <div id="tab-0-4-1-content"  style="display: none">
<div class="habblet-content-info">
    <a name="habbo-search">Gebe die ersten Buchstaben des Namens ein, um nach {{ site.siteName }}s zu suchen.</a>
</div>
...
<div id="avatar-habblet-list-search">
    ...
    <a href="#" id="avatar-habblet-search-button" class="new-button"><b>Suchen</b><i></i></a>
</div>
...
<script type="text/javascript">
    L10N.put("habblet.search.error.search_string_too_long", "Der Name war zu lang. Die max. Länge beträgt 30 Zeichen.");
    L10N.put("habblet.search.error.search_string_too_short", "Der Name war zu kurz. Min. 2 Zeichen erforderlich.");
    L10N.put("habblet.search.add_friend.title", "Zu Freunden hinzufügen");
...
<div id="friend-invitation-habblet-container" class="box-content">
    ...
    <div id="invitation-form" class="clearfix">
        <textarea name="invitation_message" id="invitation_message" class="invitation-message">Komm, wir chillen im {{ site.siteName }}.- {{ playerDetails.getName() }}</textarea>
    ...
    <div class="invitation-buttons clearfix" id="invitation_buttons">
		<a  class="new-button" id="send-friend-invite-button" href="#"><b>Freunde Einladen</b><i></i></a>
    </div>
    
    <hr/>
    </div>
    <div id="invitation-link-container">
        <h3>Genieße {{ site.siteName }} mehr mit echten Freunden!</h3>

        <div class="copytext">
            <p>Lade deine Freunde zu Habbo ein und verdiene coole Abzeichen! Schicke ihnen einen Link und bitte Sie, sich zu registrieren. Wenn Sie Habbo aktiv nutzen, erhältst du dein Abzeichen.</p>
        </div>
        <div class="invitation-buttons clearfix"> 
            <a  class="new-button" id="getlink-friend-invite-button" href="#"><b>Einladungslink anzeigen</b><i></i></a>
        </div>
    </div>
</div>
<script type="text/javascript">
    L10N.put("invitation.button.invite", "Freunde einladen");
    L10N.put("invitation.form.recipient", "Freundes Emailadresse:");
...
<div class="habblet-container ">		
	...
	<p>Durchsuche die neuesten Ereignisse nach Kategorie</p>
	<select id="event-category">
		<option value="1">Partys &amp; Musik</option>
		<option value="2">Tausch</option>
		<option value="3">Games</option>
		<option value="4">Retro Guides</option>
		<option value="5">Debatten &amp; Diskussionen</option>
		<option value="6">Neueröffnung</option>
		<option value="7">Dating</option>
		<option value="8">Jobs</option>
		<option value="9">Gruppenevents</option>
		<option value="10">Leistung</option>
		<option value="11">Hilfe-Abteil</option>
	</select>
	</div>
	<div id="event-list">
		{% set eventCategory = 1 %}
...
<div id="column2" class="column">
        ...
        <div id="topstories">
	        <div class="topstory" style="background-image: url({{ article1.getLiveTopStory() }})">
	            ...
	            <p>
	                <a href="{{ site.sitePath }}/articles/{{ article1.getUrl() }}">Mehr lesen &raquo;</a>
	            </p>
	        </div>
	        <div class="topstory" style="background-image: url({{ article2.getLiveTopStory() }}); display: none">
	            ...
	            <p>
	                <a href="{{ site.sitePath }}/articles/{{ article2.getUrl() }}">Mehr lesen &raquo;</a>
	            </p>
	        </div>
	        <div class="topstory" style="background-image: url({{ article3.getLiveTopStory() }}); display: none">
	            ...
	            <p>
	                <a href="{{ site.sitePath }}/articles/{{ article3.getUrl() }}">Mehr lesen &raquo;</a>
	            </p>
	        </div>
            <div id="topstories-nav" style="display: none"><a href="#" class="prev">&laquo; Zurück</a><span>1</span> / 3<a href="#" class="next">Vor &raquo</a></div>
        </div>
        <ul class="widelist">
            <li class="even">
            ...
            <li class="last"><a href="{{ site.sitePath }}/articles">Mehr lesen &raquo;</a></li>
        </ul>
</div>
<script type="text/javascript">
...
<div class="box-tabs-container clearfix">
    <h2>Tag</h2>
							...
							<ul class="box-tabs">
								<li id="tab-1-5-1"><a href="#">{{ site.siteName }}s mögen..</a><span class="tab-spacer"></span></li>
								<li id="tab-1-5-2" class="selected"><a href="#">Meine Tags</a><span class="tab-spacer"></span></li>
							</ul>
						</div>
						...
						<div id="tab-1-5-2-content" >
							...
							{% if tags|length < 1 %}
							Du hast keine Tags.
							{% endif %} Beantworte die Frage unten oder füge einfach ein Tag deiner Wahl hinzu.		    </div>
...
document.observe("dom:loaded", function() {
    TagHelper.setTexts({
        tagLimitText: "Du hast das Tag-Limit erreicht. Lösche eines deiner Tags, wenn du ein neues hinzufügen möchtest.",
        invalidTagText: "Ungültiges Tag. Das Tag muss weniger als 20 Zeichen lang sein und darf nur aus alphanumerischen Zeichen bestehen.",
        buttonText: "OK"
    });
        TagHelper.init('1');
});
...
<div class="box-tabs-container clearfix">
    <h2>Gruppe</h2>
    <ul class="box-tabs">
        <li id="tab-2-1"><a href="#">Empfohlen</a><span class="tab-spacer"></span></li>
        <li id="tab-2-2" class="selected"><a href="#">Meine Gruppen</a><span class="tab-spacer"></span></li>
    </ul>
</div>
    ...
    <div id="tab-2-2-content" >
         ...
         <div id="groups-habblet-info" class="habblet-content-info">
                Sieh dir die Gruppen an, in denen du dich befindest, erstelle eigene Gruppen oder lasse dich vom Tab 'Andere' inspirieren!         </div>
...
<ul class="habblet-list two-cols clearfix">         
		...
		<div class="habblet-button-row clearfix"><a class="new-button" id="purchase-group-button" href="#"><b>Gruppe erstellen</b><i></i></a></div>
    </div>
