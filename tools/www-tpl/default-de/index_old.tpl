				...
				{% if isValentinesMonth %}
					<div id="create-habbo" class="layout-static">
						<div id="create-habbo-nonflash" style="background-image: url({{ site.staticContentPath }}/web-gallery/v2/images/landing/custom/{{ randomValentinesImage }})">
							<div class="landing-text-1"><span>Valentinstag</span></div>
							{% if randomValentinesImage == "valentines_2_ultra.png" %}
							<div class="landing-text-2" style="left:60px"><span>Finde deinen Partner...</span></div>
							<div class="landing-text-3" style="left:170px"><span>...und schließe Freundschaften :)</span></div>
							{% else %}
							<div class="landing-text-2"><span>Finde deinen Partner...</span></div>
							<div class="landing-text-3"><span>...und schließe Freundschaften :)</span></div>							
							{% endif %}
				...
				{% else %}
					<div id="create-habbo" class="layout-static">
						<div id="create-habbo-nonflash" style="background-image: url({{ site.staticContentPath }}/web-gallery/v2/images/landing/pixel.gif)">
							<div class="landing-text-1"><span>Virtuelle Welt, realer Spaß</span></div>
							<div class="landing-text-2"><span>Erstell dein Habbo...</span></div>
							<div class="landing-text-3"><span>...und schließe neue Freundschaften :)</span></div>
							<div id="landing-register-text"><a href="https://classichabbo.com/register"><span>Tritt bei, es ist kostenlos »</span></a></div>
							<div id="landing-promotional-text"><span>Habbo ist eine virtuelle Welt, in der du neue Freunde finden kannst.</span></div>
						</div>
					</div>
				{% endif %}
</div>
   ...
   <li>{{ alert.message }}</li>
    ...
    <div class="box-content clearfix" id="login-habblet">
        <form action="{{ site.sitePath }}/account/submit" method="post" class="login-habblet">
                ...
                <li class="no-label">
                    <a href="{{ site.sitePath }}/register" class="login-register-link"><span>Kostenlos registrieren</span></a>
                </li>
                <li class="no-label">
                    <a href="{{ site.sitePath }}/account/password/forgot" id="forgot-password"><span>Daten vergessen</span></a>
                </li>
            </ul>
        </form>
...
<div id="remember-me-notification" class="bottom-bubble" style="display:none;">
	...
	Wenn du Angemeldet bleiben auswählst, bleibst du auf diesem Computer angemeldet, bis du dich abmeldest. Verwende diese Funktion bitte nicht, wenn es sich um einen öffentlichen Computer handelt.	</div>
...
<div id="geoip-ad" style="display:none"></div>
	...
	<div class="rounded" style="background-color: orange; color: white">
			...
			Dieser Server wurde seit dem 11. Dezember 2019 aufgrund eines unglücklichen Vorfalls gelöscht.<br />
		</div>
		<br /> -->
...
<div id="column-footer">
    ...
    <span class="tags-habbos-like">{{ site.siteName }}s mögen..</span>
Keine Tags zum anzeigen.</div> -->
