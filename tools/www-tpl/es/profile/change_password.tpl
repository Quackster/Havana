...
<div class="box-content">
    ...
    <div class="habblet-container " style="float:left; width: 560px;">
        <div class="cbb clearfix settings">
            ...
            <h2 class="title">Cambiar la configuración de su contraseña</h2>
            <div class="box-content">
...
<p>Si alguien le dijo que viniera aquí y cambie su contraseña a cambio de una recompensa, ¡no cambie su contraseña!</p>
...
<p>Su nueva contraseña debe tener al menos 6 caracteres.Su contraseña puede incluir letras y números en minúsculas y mayúsculas.</p>
...
<a href="#" class="new-button" style="display: none" id="pwform-submit"><b>Cambiar la contraseña</b><i></i></a>
<noscript><input type="submit" value="Cambiar la contraseña" name="save" class="submit" /></noscript>
