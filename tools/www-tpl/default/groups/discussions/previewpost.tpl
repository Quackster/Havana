	...
	<td class="post-list-message" valign="top" colspan="2">
        ...
        <div>
                <div id="discussion-captcha-preview"></div>                <div class="button-area">
  		            <a id="post-form-cancel-preview" class="new-button red-button cancel-icon" href="#"><b><span></span>{{ locale.groups_discussions_cancel }}</b><i></i></a>
		            <a id="post-form-save-preview" class="new-button green-button save-icon" href="#"><b><span></span>{{ locale.groups_discussions_save }}</b><i></i></a>
		        </div>
        </div>
	</td>
</tr>
