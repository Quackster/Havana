{% autoescape 'html' %}
							<div id="category-list">
								...
								{{ locale.profile_profile_widgets_friend_categories }}
								</div>
								<div class="category-default category-item selected-category" id="category-item-0">{{ locale.profile_profile_widgets_friends }}</div>
