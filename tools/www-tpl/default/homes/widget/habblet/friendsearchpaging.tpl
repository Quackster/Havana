...
{% if friends > 0 %}
	...
	<div class="avatar-list-avatar"><img src="https://cdn.classichabbo.com/habbo-imaging/avatarimage?figure={{ friend.getFigure() }}&size=s&direction=4&head_direction=4&crr=0&gesture=&frame=1" alt="" /></div>
