...
public class Routes {
    ...
    public static void register() {
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/pages", HousekeepingCatalogueController::pages);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/pages/edit", HousekeepingCatalogueController::editPage);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/pages/delete", HousekeepingCatalogueController::deletePage);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/items", HousekeepingCatalogueController::items);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/items/edit", HousekeepingCatalogueController::editItem);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/items/delete", HousekeepingCatalogueController::deleteItem);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/packages", HousekeepingCatalogueController::packages);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/packages/edit", HousekeepingCatalogueController::editPackage);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/packages/delete", HousekeepingCatalogueController::deletePackage);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/sale_badges", HousekeepingCatalogueController::saleBadges);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/sale_badges/delete", HousekeepingCatalogueController::deleteSaleBadge);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/collectables", HousekeepingCatalogueController::collectables);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/collectables/edit", HousekeepingCatalogueController::editCollectable);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/catalogue/collectables/delete", HousekeepingCatalogueController::deleteCollectable);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/item_definitions", HousekeepingGameDataController::itemDefinitions);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/item_definitions/edit", HousekeepingGameDataController::editItemDefinition);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/item_definitions/delete", HousekeepingGameDataController::deleteItemDefinition);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/vouchers", HousekeepingGameDataController::vouchers);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/vouchers/edit", HousekeepingGameDataController::editVoucher);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/vouchers/delete", HousekeepingGameDataController::deleteVoucher);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/wordfilter", HousekeepingGameDataController::wordfilter);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/wordfilter/edit", HousekeepingGameDataController::editWordfilter);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/wordfilter/delete", HousekeepingGameDataController::deleteWordfilter);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/recycler_rewards", HousekeepingGameDataController::recyclerRewards);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/recycler_rewards/edit", HousekeepingGameDataController::editRecyclerReward);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/recycler_rewards/delete", HousekeepingGameDataController::deleteRecyclerReward);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/room_categories", HousekeepingGameDataController::roomCategories);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/room_categories/edit", HousekeepingGameDataController::editRoomCategory);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/room_categories/delete", HousekeepingGameDataController::deleteRoomCategory);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/room_models", HousekeepingGameDataController::roomModels);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/room_models/edit", HousekeepingGameDataController::editRoomModel);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/room_models/delete", HousekeepingGameDataController::deleteRoomModel);
        ...
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/badges/update", HousekeepingGameDataController::updateBadge);
        RouteManager.addRoute("/" + HOUSEKEEPING_PATH + "/badges/remove", HousekeepingGameDataController::removeBadge);
    }
}
