...
function isElementLimitReached() {
	if (getElementCount() >= {{ stickerLimit }}) {
		showHabboHomeMessageBox("Erro", "Você já atingiu o número máximo de elementos na página. Remova um adesivo, nota ou widget para poder colocar este item.", "Fechar");
		return true;
	}
	return false;
}
...
<div class="box-tabs-container box-tabs-left clearfix">
	...
	{% if user.id == playerDetails.id %}
	{% if editMode == false %}
	<a href="{{ site.sitePath }}/myhabbo/startSession/{{ user.id }}" id="edit-button" class="new-button dark-button edit-icon" style="float:left"><b><span></span>Editar</b><i></i></a>
	{% endif %}
	{% endif %}
	{% endif %}
...
<div id="top-toolbar" class="clearfix">
	<ul>
		<li><a href="#" id="inventory-button">Inventário</a></li>
		<li><a href="#" id="webstore-button">Loja virtual</a></li>
	</ul>
	...
	<form action="#" method="get" style="width: 50%">
		...
		<a id="save-button" class="new-button green-button save-icon" href="#"><b><span></span>Salvar alterações</b><i></i></a>
	</form>
</div>
...
<div id="edit-menu" class="menu">
	...
	<select id="edit-menu-skins-select">
			...
			<option value="9" id="edit-menu-skins-select-default">Sem fundo</option>	
			{% endif %}
			<option value="3" id="edit-menu-skins-select-metalskin">Metal</option>
			<option value="5" id="edit-menu-skins-select-notepadskin">Nota</option>
			<option value="2" id="edit-menu-skins-select-speechbubbleskin">Balão de fala</option>
			<option value="4" id="edit-menu-skins-select-noteitskin">Nota adesiva</option>
			...
			{% endif %}
				...
				<div id="edit-menu-stickie">
					...
					<p>Aviso! Se você clicar em ‘Remover’, a nota será excluída permanentemente.</p>
				</div>
				...
				<div id="edit-menu-remove-group-warning">
					<p>Aviso! Se você clicar em 'Remover', este item pertencerá a outro usuário. Se você removê-la, ela retornará ao inventário. A nota será excluída permanentemente.</p>
...
<div class="cbb topdialog" id="guestbook-form-dialog">
	<h2 class="title dialog-handle">Editar Livro de visitas</h2>
...
<ul class="box-tabs">
	...
	<li id="group-memberlist-link-pending"><a href="#">Membros pendentes</a><span class="tab-spacer"></span></li>
</ul>
</div>
...
<div id="group-memberlist-members-buttons" class="clearfix">
	<a href="#" class="new-button group-memberlist-button-disabled" id="group-memberlist-button-give-rights"><b>Dar direitos</b><i></i></a>
	<a href="#" class="new-button group-memberlist-button-disabled" id="group-memberlist-button-revoke-rights"><b>Revogar direitos</b><i></i></a>
