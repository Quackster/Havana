<div class="box-content">
    <div id="hc-catalog">
	  ...
	  {% if currentPage != 1 %}
      <div class="hc-catalog-navi">
        <a href="/credits/habboclub?month=0&catalogpage=0" onclick="return habboclub.catalogUpdate({{ currentPage - 1}}, 0)">Zurück</a>
      </div>
	  {% else %}
	  <div class="hc-catalog-navi">
	    Zurück
	...
	{% if currentPage != lastPage %}
	  <div class="hc-catalog-monthNumber">
        <a href="/credits/habboclub?month=0&catalogpage=0" onclick="return habboclub.catalogUpdate({{ currentPage + 1 }}, 0)">Vor</a>
      </div>
	  {% else %}
	  <div class="hc-catalog-monthNumber">
        Vor
