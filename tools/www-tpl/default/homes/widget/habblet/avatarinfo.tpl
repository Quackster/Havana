<div class="avatar-list-info-container">
	<div class="avatar-info-basic clearfix">
		...
		<div class="avatar-info-image">
						<img src="{{ site.sitePath }}/habbo-imaging/avatarimage?figure={{ avatar.getFigure() }}&size=b&direction=4&head_direction=4&crr=0&gesture=&frame=1" alt="{{ locale.homes_widget_test }}" />
		</div>
...
<p>{{ locale.homes_widget_habbo_created_on }} <b>{{ avatar.getCreatedAt() }}</b></p>
<p><a href="{{ site.sitePath }}/home/{{ avatar.getName() }}" class="arrow">{{ locale.homes_widget_view_habbo_page }}</a></p>
	</div>
</div>