   ...
   <li>{{ alert.message }}</li>
               ...
               <div class="habblet-container ">
                  ...
                  <script type="text/javascript">
                     ...
                     var i = 0;
                     sb.add("fp-bubble-"+i++, "frontpage-image", 365, 62, "Entwerfe dein Habbo...");
                     sb.add("fp-bubble-"+i++, "frontpage-image", 372, 159, "...und lerne jeden kennen!");
                     sb.add("fp-bubble-"+i++, "frontpage-image", 115, 83, "Trete jetzt der größten virtuellen Welt bei.");
               ...
               <div class="habblet-container ">
                  <div class="cbb habblet box-content" id="tag-cloud-slim">
                     ...
                     <ul class="tag-list">
						...
						{% endfor %}
						{% else %}
						<li><span class="tags-habbos-like">Retro, Habbo, Free, 2009, Best Game, E.druid</span></li>
						{% endif %}
						{% endautoescape %}
                     </ul>
                  </div>
