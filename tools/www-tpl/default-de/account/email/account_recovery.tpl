...
<head>
	...
	<title>{{ site.siteName }}: Wiederherstellung </title>
...
<style type="text/css">
    ...
    <h2 class="title">Account Wiederherstellung</h2>
    <div class="box-content">
		...
		<h2 class="title" style="background-color: #429B00;">Wiederherstellung</h2>
		<div class="box-content">
        <p>Bitte gebe unten dein neues Passwort ein und bestätigen es, um dein Konto wiederherzustellen.</p>
		<div class="clear"></div>
        <form method="post" action="recovery" id="accountlist-form">
			...
			<div class="clear"></div>
			<p>
            <label for="confirmpassword-field">Passwort bestätigen</label>
		...
		<!-- <a href="{{ site.sitePath }}/">Gehe zur {{ site.siteName }} Hauptseite.</a> -->
