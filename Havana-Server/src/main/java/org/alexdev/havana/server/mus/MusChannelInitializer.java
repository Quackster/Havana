...
import org.alexdev.havana.server.mus.codec.MusNetworkDecoder;
import org.alexdev.havana.server.mus.codec.MusNetworkEncoder;
...
public class MusChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel socketChannel) throws Exception {
        ...
        pipeline.addLast("handler", new MusConnectionHandler());
    }
}
