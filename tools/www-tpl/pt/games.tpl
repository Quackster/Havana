...
<head>
	...
	<title>{{ site.siteName }}: Jogos </title>
    ...
    <div id="column1" class="column">
				<div class="habblet-container ">		
						<div class="cbb clearfix green ">
							...
							<h2 class="title">Jogos Recomendados
							</h2>
	...
	<li><a href="/groups/lido">Lido Diving »</a></li>
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix orange ">
							...
							<h2 class="title">Maiores Pontuações
							</h2>
...
<div id="column2" class="column">
				<div class="habblet-container ">		
						<div class="cbb clearfix green ">
							...
							<h2 class="title">Ingresso para a diversão
							</h2>
						<div class="box-content">
	<div id="game-promo">
		Por 1 moeda você compra 2 ingressos para jogos, ou você pode comprar 20 ingressos por 6 moedas.
	</div>
</div>
			...
			<div class="habblet-container ">		
				<div class="cbb clearfix">
					<h2 class="title" style="background-color: lightblue">Pontuações</h2>
					<div class="habblet-text">							</h2>
						<div class="row">
							...
							<div class="column" style="width: 170px;">
								...
								<p style="margin-top: 10px">Os resultados seguintes foram obtidos mês a mês.</p>
								<p>Para ver as pontuações obtidas desde que a pontuação do jogo foi coletada, clique <a href="{{ site.sitePath }}/games/score_all_time">aqui</a>.</p>
								{% else %}
								<p style="margin-top: 10px">Os resultados a seguir são pontuações obtidas em todos os tempos.</p>
								<p>Para ver as pontuações obtidas mês a mês desde que a pontuação do jogo foi coletada, clique <a href="{{ site.sitePath }}/games">aqui</a>.</p>								
								{% endif %}
							</div>
						</div>
					</div>
