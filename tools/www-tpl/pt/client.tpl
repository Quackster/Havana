...
{{ site.formattedUsersOnline }} {{ site.siteName }}s online</div>
  ...
  <div class="logout"><a href="{{ site.sitePath }}/account/logout?origin=popup" onclick="self.close(); return false;">Fechar Hotel</a></div>
</div>
<noscript>
...
<div id="clientembed-loader" class="loader-image" style="display:none">
    <div class="loader-image-inner">
        <b class="loading-text">Carregando {{ site.siteName }}...</b>
    </div>
</div>
<div id="clientembed">
...
HabboClientUtils.showLoader(["Carregando {{ site.siteName }}", "Carregando {{ site.siteName }}.", "Carregando {{ site.siteName }}..", "Carregando {{ site.siteName }}..."]);
</script>
