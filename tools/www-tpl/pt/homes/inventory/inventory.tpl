...
<p><b>Seu inventário para esta categoria está completamente vazio!</b></p>
<p>Para poder adquirir adesivos, planos de fundo e notas, clique na aba Loja Web e selecione uma categoria e um produto e clique em Comprar.</p>
...
<div id="inventory-preview-place" class="clearfix">
	<div class="clearfix">
		<a href="#" class="new-button" id="inventory-place"><b>usar</b><i></i></a>
	</div>
</div>
{% endif %}
