...
{% endif %}
		<span class="header-left">&nbsp;</span><span class="header-middle">{{ locale.homes_widget_my_rating }}</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
...
{% endif %}
		...
		<b>{{ locale.homes_widget_average_rating }} {{ average }}</b><br/>
	...
	{{ sticker.getVoteCount() }} {{ locale.homes_widget_votes_total }}	
	<br/>
	({{ sticker.getHighVoteCount() }} {{ locale.homes_widget_users_voted_four_or_better }}
</div>
	</div>
		<div class="clear"></div>
		</div>
