...
<head>
    ...
    <script type="text/javascript">
        ...
        var flashvars = {
            ...
            "account_id": "1",
            "client.starting": "Das Hotel wird geladen, bitte warte.",
            ...
            <div id="flash-container">
                <div id="content" style="width: 400px; margin: 20px auto 0 auto;">
                    <div class="cbb clearfix">
                        <h2 class="title">Bitte aktualisiere dein Flash Player auf die gebrauchte Version.</h2>
						<div class="box-content">
							<p>Du kannst Adobe Flash Player hier herunterladen und installieren: <a href="http://get.adobe.com/flashplayer/">Installiere Flash</a>. Weitere Anweisungen zur Installation findest du hier: <a href="http://www.adobe.com/products/flashplayer/productinfo/instructions/">Weitere Informationen</a></p>
							<p><a href="http://www.adobe.com/go/getflashplayer"><img src="http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="Hol dir den Adobe Flash player" /></a></p>
						</div>
                    </div>
                </div>
                <noscript>
					<div style="width: 400px; margin: 20px auto 0 auto; text-align: center">
						<p>Wenn du nicht automatisch weitergeleitet wirst, <a href="/client/nojs">klicke hier</a></p>
					</div>
                </noscript>
            </div>
        </div>
