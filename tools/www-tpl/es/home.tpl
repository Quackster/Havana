...
function showSaveOverlay() {
	...
	if (invalidPos.length > 0) {
	    ...
	    showHabboHomeMessageBox("¡Ups! ¡No puedes hacer eso!", "Lo siento, pero no puedes colocar tus pegatinas, notas o widgets aquí.Cierre la ventana para continuar editando su página.", "Cerrar");
		return false;
	} else {
	...
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><h2><p style="color:#9D9D9D">Yo soy la enfermedad, soy el dolor ...</p></h2></div>
...
<div class="movable stickie n_skin_nakedskin-c" style=" left: 73px; top: 121px; z-index: 7;" id="stickie-3188552">
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><h2><p style="color:#FFFFFF">... Soy la muerte que nunca muere ...</p></h2></div>
				<div class="stickie-footer">
				</div>
			</div>
		</div>
...
<div class="movable stickie n_skin_nakedskin-c" style=" left: 315px; top: 660px; z-index: 8;" id="stickie-3188551">
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><h1><p style="color:#007400">... El día de Halloween vendré a jugar ...</p></h1></div>
				<div class="stickie-footer">
				</div>
			</div>
		</div>
...
<div class="movable stickie n_skin_nakedskin-c" style=" left: 425px; top: 55px; z-index: 6;">
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><p style="color:#FFFFFF">... mi vida se perdió en la lluvia del virus ...</p></div>
				<div class="stickie-footer">
				</div>
			</div>
		</div>
...
<div class="movable stickie n_skin_nakedskin-c" style=" left: 220px; top: 85px; z-index: 9;">
	<div class="n_skin_nakedskin">
		...
		<div class="stickie-body">
			<div class="stickie-content">
				<div class="stickie-markup"><h3><p style="color:#727272">... Soy el pobre que llora ...</p></h3></div>
				<div class="stickie-footer">
				</div>
			</div>
		</div>
...
<div id="edit-menu" class="menu">
	...
	<select id="edit-menu-skins-select">
			...
			<option value="9" id="edit-menu-skins-select-default">Sin Tema</option>	
			{% endif %}
			...
			{% endif %}
				...
				<div id="edit-menu-gb-availability">
					<select id="guestbook-privacy-options">
						<option value="private"{% if (editMode == true) and (guestbookSetting == "private") %} selected{% endif %}>Solo amigos</option>
						<option value="public"{% if (editMode == true) and (guestbookSetting == "public") %} selected{% endif %}>Pública</option>
					</select>
				</div>
...
<form method="post" id="guestbook-form">
    ...
    <script type="text/javascript">
        ...
        bbcodeToolbar.toolbar.toolbar.id = "bbcode_toolbar";
		        var colors = { "rojo" : ["#d80000", "Roja"],
            "naranja" : ["#fe6301", "Naranja"],
            "amarilla" : ["#ffce00", "Amarilla"],
            "verde" : ["#6cc800", "Verde"],
            "cian" : ["#00c6c4", "Cian"],
            "azul" : ["#0070d7", "Azul"],
            "gris" : ["#828282", "Gris"],
...
<div id="linktool">
    ...
    <a href="#" class="new-button" id="linktool-find"><b>Encontrar</b><i></i></a>
...
<div id="group-memberlist-members-buttons" class="clearfix">
	...
	<a href="#" class="new-button group-memberlist-button-disabled" id="group-memberlist-button-revoke-rights"><b>Revocar derechos</b><i></i></a>
