...
<div class="box-tabs-container box-tabs-left clearfix">
	...
	{% else %}
  	...
  	<a href="#" id="stop-reporting-button" style="display: none;">Melden abbrechen</a>  
		{% else %}
...
<h3>Gruppe anpassen</h3>

<ul>
	{% if (hasMember and groupMember.getMemberRank().getRankId() >= 2) %}
	<li><a href="{{ site.sitePath }}/groups/actions/startEditingSession/{{ group.id }}" id="group-tools-style">Seite anpassen</a></li>
	{% endif %}
	{% if (hasMember and groupMember.getMemberRank().getRankId() == 3) %}
	<li><a href="#" id="group-tools-settings">Einstellung</a></li>	<li><a href="#" id="group-tools-badge">Badge</a></li>
	{% endif %}
...
<div class="cbb topdialog" id="postentry-verifyemail-dialog">
	...
	<p>Du msst deine E-Mail bestätigen, bevor du neue Nachrichten posten kannst.</p>
	<p><a href="{{ site.sitePath }}/profile/profile?tab=3">Email aktivieren</a></p>
	<p class="clearfix">
...
<div class="cbb topdialog" id="postentry-delete-dialog">
	<h2 class="title dialog-handle">Diskussion löschen</h2>
