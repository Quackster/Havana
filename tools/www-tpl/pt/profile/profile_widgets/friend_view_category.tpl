...
<div id="friend-list-header-container" class="clearfix">
    <div id="friend-list-header">
        <div class="page-limit">
            <div class="big-icons friend-header-icon">Amigos                <br/>Mostrar
...
<form id="friend-list-form">
        ...
        <thead>
            <tr class="friend-list-header">
                ...
                <th class="friend-login">
                    <a class="sort">Último login</a>
                </th>
                <th class="friend-remove">Remover</th>
            </tr>
    ...
    <a class="select-all" id="friends-select-all" href="#">Selecionar Todos</a> |
    <a class="deselect-all" href=#" id="friends-deselect-all">Desmarcar Todos</a>
</form>
...
<div class="friend-del"><a class="new-button red-button cancel-icon" href="#" id="delete-friends"><b><span></span>Deletar selecionados</b><i></i></a></div>
