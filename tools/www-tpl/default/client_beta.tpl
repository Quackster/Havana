...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{{ locale.global_html_lang }}" lang="{{ locale.global_html_lang }}" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml">

<head>
    <meta http-equiv="content-type" content="text/html" />
    <title>{{ site.siteName }}{{ locale.client_beta_hotel }}</title>
    ...
    <script type="text/javascript">
        ...
        var flashvars = {
            ...
            "external.variables.txt": "{{ site.loaderFlashBetaVariables }}",
            "external.texts.txt": "{{ site.loaderFlashBetaTexts }}",
            "use.sso.ticket": "1",
            "sso.ticket": "{{ ssoTicket }}",
            "processlog.enabled": "1",
            "account_id": "1",
            "client.starting": "{{ locale.client_beta_hotel_is_loading_please_wait|escape('js') }}",
            "flash.client.url": "{{ site.loaderFlashBetaBase }}",
            "user.hash": "ticket",
            "has.identity": "0",
        ...
        var clientUrl = "{{ site.loaderFlashBetaSwf }}";
            ...
            <div id="flash-container">
                <div id="content" style="width: 400px; margin: 20px auto 0 auto;">
                    <div class="cbb clearfix">
                        <h2 class="title">{{ locale.client_beta_please_update_your_flash_player_to_the_latest_version }}</h2>
						<div class="box-content">
							<p>{{ locale.client_beta_you_can_install_and_download_adobe_flash_player_here }} <a href="http://get.adobe.com/flashplayer/">{{ locale.client_beta_install_flash_player }}</a>{{ locale.client_beta_more_instructions_for_installation_can_be_found_here }} <a href="http://www.adobe.com/products/flashplayer/productinfo/instructions/">{{ locale.client_beta_more_information }}</a></p>
							<p><a href="http://www.adobe.com/go/getflashplayer"><img src="http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="{{ locale.client_beta_get_adobe_flash_player }}" /></a></p>
						</div>
                    </div>
                </div>
                <noscript>
					<div style="width: 400px; margin: 20px auto 0 auto; text-align: center">
						<p>{{ locale.client_beta_if_you_are_not_automatically_redirected_please }} <a href="/client/nojs">{{ locale.client_beta_click_here }}</a></p>
					</div>
                </noscript>
            </div>
        </div>
