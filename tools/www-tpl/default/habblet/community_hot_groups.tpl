...
<div id="hotgroups-habblet-list-container" class="habblet-list-container groups-list">
    ...
    <div class="clearfix">
        <a href="#" class="hotgroups-toggle-more-data secondary" id="hotgroups-toggle-more-data-h122">{{ locale.habblet_community_hot_groups_show_more_groups }}</a>
    </div>
<script type="text/javascript">
L10N.put("show.more.groups", "{{ locale.habblet_community_hot_groups_show_more_groups|escape('js') }}");
L10N.put("show.less.groups", "{{ locale.habblet_community_hot_groups_show_less_groups|escape('js') }}");
