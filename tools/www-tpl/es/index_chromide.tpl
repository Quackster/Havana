   ...
   <li>{{ alert.message }}</li>
                           ...
                           <form action="{{ site.sitePath }}/account/submit" method="post" class="login-habblet">
                              <ul>
                                 ...
                                 <li id="remember-me" class="no-label">
									...
									{% endif %}
                                    <label for="login-remember-me">Recuérdame</label>
                                 </li>
                                 <li id="register-link" class="no-label">
                                    <a href="{{ site.sitePath }}/register" class="login-register-link"><span>Register for free</span></a>
                                 </li>
                                 <li class="no-label">
                                    <a href="{{ site.sitePath }}/account/password/forgot" id="forgot-password"><span>Olvidé mi contraseña/nombre de usuario</span></a>
                                 </li>
                              </ul>
               ...
               <div class="habblet-container ">
                  ...
                  <script type="text/javascript">
					...
					sb.add("fp-bubble-"+i++, "frontpage-image", 93, 249, "Únete a nosotros en Habbo, el mundo virtual más grande del mundo.");
            ...
            <div id="column-footer">
               <div class="habblet-container ">
                  <div class="cbb" id="hotel-stats">
                     <ul class="stats">
                        <li class="stats-online"><span class="stats-fig">{{ site.usersOnline }}</span> {{ site.siteName }}s en línea ahora!</li>
                        <li class="stats-visited"><span class="stats-fig">{{ site.visits }}</span> visitas en los últimos 30 días</li>
                     </ul>
                  </div>
               </div>
               <script type="text/javascript">if (!$(document.body).hasClassName('process-template')) { Rounder.init(); }</script>
               <div class="habblet-container ">
                  <div class="cbb habblet box-content" id="tag-cloud-slim">
                     <span class="tags-habbos-like">{{ site.siteName }}s Gustan</span>
                     <ul class="tag-list">
						{% autoescape 'html' %}
						...
						{% endfor %}
						{% else %}
						<li><span class="tags-habbos-like">No hay etiquetas para mostrar.</span></li>
						{% endif %}
						{% endautoescape %}
                     </ul>
                  </div>
