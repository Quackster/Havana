...
<head>
	...
	<title>{{ site.siteName }} ~ Juegos </title>
    ...
    <div id="column1" class="column">
				<div class="habblet-container ">		
						<div class="cbb clearfix green ">
							...
							<h2 class="title">Juegos Recomendados
							</h2>
	...
	<li><a href="/groups/lido">Lido Diving »</a></li>
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix orange ">
							...
							<h2 class="title">Puntuaciones altas
							</h2>
...
<div id="column2" class="column">
				<div class="habblet-container ">		
						<div class="cbb clearfix green ">
							...
							<h2 class="title">Tu boleto a la emoción
							</h2>
						<div class="box-content">
	<div id="game-promo">
		Los boletos de juego cuestan 1 moneda para 2, o puedes comprar 20 boletos para 6 Monedas.
	</div>
</div>
			...
			<div class="habblet-container ">		
				<div class="cbb clearfix">
					<h2 class="title" style="background-color: lightblue">Puntuación</h2>
					<div class="habblet-text">							</h2>
						<div class="row">
							...
							<div class="column" style="width: 170px;">
								...
								<p style="margin-top: 10px">Los siguientes resultados son puntajes obtenidos de mes a mes.</p>
								<p>Para ver los puntajes ganados todo el tiempo desde que se ha recopilado la puntuación del juego, haga clic en <a href="{{ site.sitePath }}/games/score_all_time">aquí</a>.</p>
								{% else %}
								<p style="margin-top: 10px">Los siguientes resultados son puntajes ganados todo el tiempo.</p>
								<p>Para ver los puntajes ganados mes a mes desde que se ha recopilado la puntuación del juego, haga clic en <a href="{{ site.sitePath }}/games">aquí</a>.</p>								
								{% endif %}
							</div>
						</div>
					</div>
