...
<script src="{{ site.staticContentPath }}/web-gallery/static/js/registration.js" type="text/javascript"></script>
    <script type="text/javascript">		
        ...
        L10N.put("register.error.password_numbers", "Dein Passwort muss mindestens eine Zahl oder ein Sonderzeichen enthalten.");
	    ...
	    <form method="post" action="{{ site.sitePath }}/register" id="registerform" autocomplete="off">
            ...
            <div id="register-section-2">
                <div class="rounded rounded-blue">
                    <h2 class="heading"><span class="numbering white">2.</span>Gib dir einen Namen</h2>
            ...
            <div id="register-section-3">
	            ...
	            <div class="cbb clearfix gray">
    	            <h2 class="title heading"><span class="numbering white">3.</span>Deine Details	</h2>
    		        <div class="box-content">

			
                        <fieldset id="register-fieldset-password">
	                        <div class="register-label"><label for="register-password">Mein Passwort:</label></div>
	                        <div class="register-label"><input type="password" name="password" id="register-password" class="register-text" size="25" value="" /></div>
	                        <div class="register-label"><label for="register-password2">Passwort bestätigen:</label></div>
                        ...
                        <fieldset>
	                        <div class="register-label"><label for="register-email">Meine Email:</label></div>
	                        ...
	                        <div class="register-label"><label for="register-email2">Email bestätigen:</label></div>
	                    ...
	                    <div id="register-marketing-box">
		                    ...
		                    <label for="bean_marketing">Ja, sende mir bitte {{ site.siteName }} Updates, inklusive des Newsletters!</label>
	                    </div>                  
                        ...
                        <fieldset id="register-fieldset-captcha">
							<noscript>
	                            ...
	                            <div class="register-label"><label for="register-captcha">Gebe den im Bild oben angezeigten Sicherheitscode ein</label></div>
                        ...
                        <fieldset id="register-fieldset-terms">
                            <div class="rounded rounded-darkgray" id="register-terms">
	                            <div id="register-terms-content">
	                                <p><a href="{{ site.sitePath }}/papers/disclaimer" target="_blank" id="register-terms-link">Geschäftsbedingungen</a></p>
                                    <p class="last">
                                        <input type="checkbox" name="bean.termsOfServiceSelection" id="register-terms-check" value="true" />
                                        <label for="register-terms-check">Indem ich auf Weiter klicke, bestätige ich, dass ich die Nutzungsbedingungen und die Datenschutzrichtlinie gelesen und akzeptiert habe.</label>
                                    </p>
                                </div>
                            </div>
                        </fieldset>
	            ...
	            <div id="form-validation-error-box" style="display:none">
                    <div class="register-error">
                        <div class="rounded rounded-red">
                            Leider ist die Registrierung fehlgeschlagen. Bitte überprüfe deine Angaben in den roten Feldern..                        </div>
                    </div>
	            </div>
	        </div>
        </div>
	...
	<input type="hidden" name="bean.editorState" id="register-editor-state" value="" />
            ...
            <div id="register-section-3">
	            ...
	            <div class="cbb clearfix gray">
    		        ...
    		        <div class="box-content">
                        ...
                        <fieldset id="register-fieldset-password">
	                        <div class="register-label"><label for="register-password">Mein Passwort wird:</label></div>
                        ...
                        <fieldset>
	                        <div class="register-label"><label for="register-email">Und meine Email ist:</label></div>
								<div class="register-input">{{ registerEmail }}</div>
								{% if (registerEmailInvalid) %}
	                            <div id="email-error-box"><div class="register-error"><div class="rounded rounded-red">Die eingegebene E-Mail wird bereits von jemand anderem verwendet.</div></div></div>
								<div class="register-label"><label for="register-email">Neue Email Adresse:</label></div>
                        ...
                        <fieldset id="register-fieldset-captcha">
	                            ...
	                            <div id="captcha-error-box"><div class="register-error"><div class="rounded rounded-red">Der eingegebene Code ist nicht richtig. Bitte versuche es erneut.</div></div></div>
								{% endif %}
	                            <div class="register-label"><label for="register-captcha">Gebe den im Bild oben angezeigten Sicherheitscode ein</label></div>
        ...
        document.observe("dom:loaded", function() {
            Event.observe($("captcha-reload"), "click", function(e) {Utils.reloadCaptcha()});
                        ...
                        <fieldset id="register-fieldset-terms">
                            <div class="rounded rounded-darkgray" id="register-terms">
	                            <div id="register-terms-content">
	                                <p><a href="{{ site.sitePath }}/papers/termsAndConditions" target="_blank" id="register-terms-link">Geschäftsbedingungen</a></p>
                                    <p class="last">
        ...
        <div id="register-column-left">
            ...
            <div id="register-avatar-editor-title">
                ...
                <h2 class="heading"><span class="numbering white">1.</span>Erstelle dein {{ site.siteName }}</h2>
            </div>

            <div id="avatar-error-box">
            </div>
            <div id="register-avatar-editor">
                <p><b>Du hast kein Flash installiert. Deshalb können wir dir nur eine Auswahl vorgenerierter {{ site.siteName }}s zeigen. Wenn du Flash installierst, kannst du aus Hunderten von verschiedenen Optionen wählen!</b></p>
                <h3>Weiblich</h3>
                ...
                <p>Wenn dir dein {{ site.siteName }} nicht gefällt, kannst du ihn in den Einstellungen später ändern.</p>
            </div>

            <div id="register-buttons">
                <input type="submit" value="Weiter" class="continue" id="register-button-continue" />
                <a href="{{ site.sitePath }}/register/cancel" class="cancel">Beenden</a>
            </div>
	    </div>
    </form>
