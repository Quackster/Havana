  ...
  <body>
	...
	{% include "housekeeping/base/navigation.tpl" %}
		...
		function cloneAnswer() {
			...
			document.getElementById('answer' + lastID + 'title').innerHTML = "Resposta " + lastID;
		}
		...
		<form class="table-responsive col-md-4" method="post">
			...
			<div class="form-group" id="answer1">
				<label id="answer1title">Resposta 1</label>
				<input name="answers[]" type="text" class="form-control"  placeholder="Esta é uma opção que o usuário pode selecionar"></input>
			</div>
			
			<p><button type="button" class="btn btn-success" onclick="cloneAnswer()">Adicionar resposta</button></p>
			<p><button type="button" class="btn btn-primary" onclick="removeLatestAnswer()">Remover resposta</button></p>
