...
<div id="friend-list-header-container" class="clearfix">
    <div id="friend-list-header">
        <div class="page-limit">
            <div class="big-icons friend-header-icon">Freunde               <br />
...
<form id="friend-list-form">
        ...
        <thead>
            <tr class="friend-list-header">
                ...
                <th class="friend-login">
                    <a class="sort">Zuletzt Online</a>
                </th>
                <th class="friend-remove">Entfernen</th>
            </tr>
    ...
    <a class="deselect-all" href=#" id="friends-deselect-all">Alle abwählen</a>
</form>
