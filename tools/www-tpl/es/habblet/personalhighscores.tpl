...
<thead>
	<tr>
		...
		<th class="scores-points">Puntaje</th>
		{% endif %}
	</tr>
</thead>
<tbody>
{% if scoreEntries|length == 0 %}
<div class="box-content">
¡No hay puntajes grabados para este juego!
</div>
{% else %}
{% set num = 1 %}
...
<div id="habblet-paging-h116" class="highscores-habblet-paging clearfix">
		{% if hasNextPage %}
		<a href="#" class="list-paging-link next" id="h116-list-next">Próximo</a>
		{% endif %}
		
		{% if pageNumber > 1 %}
		<a href="#" class="list-paging-link previous" id="h116-list-previous">Anterior</a>
		{% endif %}
</div>
