...
<div id="friend-list-header-container" class="clearfix">
    <div id="friend-list-header">
        <div class="page-limit">
            <div class="big-icons friend-header-icon">{{ locale.profile_profile_widgets_friends }}                <br />{{ locale.profile_profile_widgets_show }}
...
<form id="friend-list-form">
        ...
        <thead>
            <tr class="friend-list-header">
                ...
                <th class="friend-name">
                    ...
                    <a class="sort">{{ locale.profile_profile_widgets_name }}</a>
                </th>
                <th class="friend-login">
                    <a class="sort">{{ locale.profile_profile_widgets_last_login }}</a>
                </th>
                <th class="friend-remove">{{ locale.profile_profile_widgets_remove }}</th>
            </tr>
    ...
    <a class="select-all" id="friends-select-all" href="#">{{ locale.profile_profile_widgets_select_all }}</a> |
    <a class="deselect-all" href=#" id="friends-deselect-all">{{ locale.profile_profile_widgets_deselect_all }}</a>
</form>
