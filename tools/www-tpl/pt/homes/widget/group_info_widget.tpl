...
<span class="header-left">&nbsp;</span><span class="header-middle">Informações do Grupo</span><span class="header-right">&nbsp;</span></h3>
		</div>	
	</div>
...
<p>Grupo criado em: <b>{{ group.getCreatedDate() }}</b></p>
