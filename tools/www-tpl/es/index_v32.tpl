   ...
   <li>{{ alert.message }}</li>
               ...
               <div class="habblet-container ">
                  ...
                  <script type="text/javascript">
                     ...
                     var i = 0;
                     sb.add("fp-bubble-"+i++, "frontpage-image", 365, 62, "Crea tu propio Habbo...");
                     sb.add("fp-bubble-"+i++, "frontpage-image", 372, 159, "... ¡Y haz nuevos amigos!");
                     sb.add("fp-bubble-"+i++, "frontpage-image", 115, 83, "Únete a nosotros en Habbo, el mundo virtual más grande del mundo.");
