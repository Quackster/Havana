...
<thead>
	<tr>
		...
		<th class="scores-points">Punkte</th>
		{% endif %}
	</tr>
</thead>
<tbody>
...
<div id="habblet-paging-h116" class="highscores-habblet-paging clearfix">
		{% if hasNextPage %}
		<a href="#" class="list-paging-link next" id="h116-list-next">Vor</a>
		{% endif %}
		
		{% if pageNumber > 1 %}
		<a href="#" class="list-paging-link previous" id="h116-list-previous">Zurück</a>
		{% endif %}
</div>
