...
<div id="container">
    ...
    <div class="box-content">
        <p>Regístrese de forma gratuita haciendo clic en Crear su habo -Button a continuación. Si ya se ha registrado, inicie sesión a la derecha.</p>
        <div class="register-button clearfix">
            <a href="{{ site.sitePath }}/register" onclick="HabboClient.closeHabboAndOpenMainWindow(this); return false;">Crea tu Habbo »</a>
            <span></span>
        </div>                
    </div>
</div>
...
<div id="remember-me-notification" class="bottom-bubble" style="display:none;">
	...
	<div class="bottom-bubble-c">
                Al seleccionar esto, permanecerá iniciado sesión en Habbo, hasta que se inicie sesión.
	</div>
