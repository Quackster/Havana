...
<div id="webstore-content-container">
	<div id="webstore-items-container">
		<h4>Klick drauf für die Vorschau:</h4>
...
<div id="inventory-preview-place" class="clearfix">
	<div class="clearfix">
		<a href="#" class="new-button" id="inventory-place"><b>Hinzufügen</b><i></i></a>
	</div>
</div>
{% endif %}
...
<div id="webstore-close-container">
	<div class="clearfix"><a href="#" id="webstore-close" class="new-button"><b>Schließen</b><i></i></a></div>
</div>
</div>