...
{% for event in events %}		
	...
	<div title="{{ locale.habblet_load_events_go_to_the_room_where_this_event_is_held }}">
		...
		<span class="event-owner"> {{ locale.habblet_load_events_by }} <a href="{{ site.sitePath }}/home/{{ creator }}">{{ creator }}</a></span>
