...
<div class="box-content">
            ...
            <ul>
				...
				{% endif %}
                </li><li class="selected">Mein Passwort
    ...
    <div class="habblet-container " style="float:left; width: 560px;">
        <div class="cbb clearfix settings">
            ...
            <h2 class="title">Ändere deine Passworteinstellungen</h2>
            <div class="box-content">
...
<p>Wenn dir jemand gesagt hat, du sollst hierher kommen um dein Passwort gegen eine Belohnung zu ändern, dann ändere dein Passwort NICHT!</p>
...
<h3>Gebe deine aktuellen Daten an</h3>
...
<p>Dein neues Passwort muss mindestens 6 Zeichen lang sein. Es kann Kleinbuchstaben, Großbuchstaben und Zahlen enthalten.</p>

<p>
<label for="bean_password">Neues Passwort</label><br /> 
...
<p>
<label for="bean_retypedPassword">Neues Passwort wiederholen</label><br />
...
<a href="#" class="new-button" style="display: none" id="pwform-submit"><b>Passwort ändern</b><i></i></a>
