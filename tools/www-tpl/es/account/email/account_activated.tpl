...
<head>
	...
	<title>{{ site.siteName }}: Email Activation </title>
...
<div class="cbb clearfix green">
    <h2 class="title" style="background-color: #429B00;">Enlace de correo electrónico manejado correctamente</h2>
    <div class="box-content">
        <span>
		Your email address is now verified.
		<br>
		<a href="{{ site.sitePath }}/">Continuar en la página principal de {{ site.siteName }}.</a>
		</span>
    </div>
</div>
{% else %}
<div class="cbb clearfix red">
    <h2 class="title">Enlace de correo electrónico manejado sin éxito</h2>
    <div class="box-content">
        <span>
		El enlace de activación no fue válido.
		<br>
		<a href="{{ site.sitePath }}/">Continuar en la página principal de {{ site.siteName }}.</a>
		</span>
    </div>
