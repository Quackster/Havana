	...
	<div id="header" class="clearfix">
       ...
       <div id="subnavi">
            <div id="subnavi-user">
                ...
                <p>
				        <a href="{{ site.sitePath }}/client" id="enter-hotel-open-medium-link" target="client" onclick="HabboClient.openOrFocus(this); return false;"> {{ site.siteName }} Hotel beitreten</a>
                </p>
            </div>
            <div id="subnavi-login">
                <form action="{{ site.sitePath }}/account/submit" method="post" id="login-form">
                    ...
                    <ul>
                        <li>
                            <label for="login-username" class="login-text"><b>Benutzername</b></label>

                            <input tabindex="1" type="text" class="login-field" name="username" id="login-username" />
		                    <a href="#" id="login-submit-new-button" class="new-button" style="float: left; display:none"><b>Anmelden</b><i></i></a>
                            <input type="submit" id="login-submit-button" value="Log in" class="submit"/>
                        </li>
                        <li>
                            <label for="login-password" class="login-text"><b>Passwort</b></label>
                            ...
                            <label for="login-remember-me" class="left">Angemeldet bleiben</label>
                        </li>
                    </ul>
                </form>
                <div id="subnavi-login-help" class="clearfix">
                    <ul>
                        <li class="register"><a href="{{ site.sitePath }}/account/password/forgot" id="forgot-password"><span>Daten vergessen</span></a></li>
                    	<li><a href="{{ site.sitePath }}/register"><span>Registrieren</span></a></li>
...
<div id="remember-me-notification" class="bottom-bubble" style="display:none;">
	...
	<div class="bottom-bubble-c">
					Wenn du Angemeldet bleiben auswählst, bleibst du auf diesem Computer angemeldet, bis du auf Abmelden klickst. Verwende diese Funktion bitte nicht, wenn es sich um einen öffentlichen Computer handelt.	</div>
	<div class="bottom-bubble-b"><div></div></div>
		...
		<ul id="navi">
			<li id="tab-register-now"><a href="{{ site.sitePath }}/register">Jetzt Registrieren!</a><span></span></li>
			...
			<li class="selected">
				<strong>Spiele</strong>			<span></span>
			</li>
			{% else %}
			<li>
				<a href="{{ site.sitePath }}/games">Spiele</a>			<span></span>
			</li>
			{% endif %}
	...
	<div id="header" class="clearfix">
        ...
        <div id="subnavi">
            ...
            <div id="to-hotel">
						...
						<a href="{{ site.sitePath }}/client" class="new-button green-button" target="client" onclick="HabboClient.openOrFocus(this); return false;"><b> {{ site.siteName }} 
                        Hotel beitreten</b><i></i></a>
                        {% else %}
                        <div id="hotel-closed-medium">{{ site.siteName }} Hotel ist Offline</div>
                        {% endif %}
			</div>
        </div>
		<script type="text/javascript">
		L10N.put("purchase.group.title", "Gruppe gründen");
		...
		<ul id="navi">
			...
			{% if session.currentPage == "credits" %}
			<li class="selected">
				<strong>Münzen</strong>			<span></span>
			</li>
			{% else %}
			<li>
				<a href="{{ site.sitePath }}/credits">Münzen</a>			<span></span>
			...
			{% if playerDetails.getRank().getRankId() >= 6 %}
				<li id="tab-register-now"><a href="{{ site.sitePath }}/allseeingeye/hk/">Hausverwaltung</a><span></span></li>
			{% endif %}
