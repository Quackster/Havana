...
<tr class="post-list-index-preview">
	<td class="post-list-row-container">
			...
			{% endif %}
		<div class="post-list-posts post-list-creator-info">Antworten: {{ userReplies }}</div>
		<div class="clearfix">
	...
	<td class="post-list-message" valign="top" colspan="2">
            <a href="#" id="edit-post-message" class="resume-edit-link">&laquo; Ändern</a>
        ...
        <div>
                <div id="discussion-captcha-preview"></div>                <div class="button-area">
  		              <a id="topic-form-cancel-preview" class="new-button red-button cancel-icon" href="#"><b><span></span>Abbrechen</b><i></i></a>
		            <a id="topic-form-save-preview" class="new-button green-button save-icon" href="#"><b><span></span>Speichern</b><i></i></a>
		        </div>
        </div>
	</td>
</tr>
