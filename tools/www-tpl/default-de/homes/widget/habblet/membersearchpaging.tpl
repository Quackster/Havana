			...
			<div id="avatarlist-content">
				...
				<div id="avatar-list-paging">
					{% if members > 0 %}
						...
						<a href="#" class="avatar-list-paging-link" id="avatarlist-search-first" >Erste</a> |
						...
						<a href="#" class="avatar-list-paging-link" id="avatarlist-search-last" >Letzte</a>
						{% else %}
						&gt;&gt; | Letzte
						{% endif %}
					{% else %}
