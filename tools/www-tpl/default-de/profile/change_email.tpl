...
<head>
	...
	<title>{{ site.siteName }}: Meine Details </title>
...
<div class="box-content">
    ...
    <div class="habblet-container " style="float:left; width: 560px;">
        <div class="cbb clearfix settings">
            ...
            <h2 class="title">Ändere deine Emaileinstellungen</h2>
            <div class="box-content">
...
<h3>Du hast nicht bestätigt, dass deine E-Mail gültig ist!</h3>

<p class="last">
Wie aktiviere ich mein Konto und bestätige meine E-Mail-Adresse? Klicke auf die Schaltfläche, um eine Bestätigungs-Email an dich zu senden. Klicke auf den Link in der Email und fertig! Klicke unten auf die Schaltfläche, wenn du eine weitere Email erhalten möchtest.</p>

<div class="settings-buttons">
<a href="#" class="new-button" style="display: none" id="confirmform-submit"><b>Email aktivieren</b><i></i></a>
...
<h3>Gib deine aktuellen Daten ein</h3>
...
<h3>Gib deine neue Email ein</h3>

<p>Stelle sicher, dass deine E-Mail-Adresse korrekt eingegeben ist. Der Link zur Bestätigung wird an diese gesendet.</p>
...
<p>
<input name="directemail" id="directemail"  type="checkbox"> <label for="directemail">Ja! Ich möchte die neuesten Habbo-Neuigkeiten direkt in mein Postfach erhalten.</label>
</p>
...
<h3>
<label for="bean_captcha" class="registration-text">Gebe den unten angezeigten Sicherheitscode ein.</label>
</h3>
...
<div class="settings-buttons">
<a href="#" class="new-button" style="display: none" id="emailform-submit"><b>Änderung speichern</b><i></i></a>
