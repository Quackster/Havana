...
<head>
	...
	<title>{{ site.siteName }}: Tag Suche </title>
    ...
    <div id="column1" class="column">
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix default ">
							...
							<h2 class="title">Beliebte Tags							</h2>
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix default ">
							...
							<h2 class="title">Tagoleum						</h2>
						<div id="tag-fight-habblet-container">
<div class="fight-process" id="fight-process">Es geht um die Wurst...</div>
<div id="fightForm" class="fight-form">
    <div class="tag-field-container">Erster Tag<br /><input maxlength="30" type="text" class="tag-input" name="tag1" id="tag1"/></div>

    <div class="tag-field-container">Zweiter Tag<br /><input maxlength="30" type="text" class="tag-input" name="tag2" id="tag2"/></div>
</div>
<div id="fightResults" class="fight-results">
    <div class="fight-image">
        ...
        <a id="tag-fight-button" href="#" class="new-button" onclick="TagFight.init(); return false;"><b>Kämpft!</b><i></i></a>
    </div>
</div>
...
<div id="tag-match-result">
    Gib den Namen deines Freundes ein, um zu sehen wie gut ihr beide zusammenpasst.</div>
