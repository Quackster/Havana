...
<div class="box-tabs-container box-tabs-left clearfix">
    ...
    <h2 class="page-owner">
    	...
    	{{ group.getName }} 
		{% endautoescape %}
		{% if group.getGroupType() == 1 %}<img src="{{ site.staticContentPath }}/web-gallery/images/groups/status_exclusive_big.gif" width="18" height="16" alt="{{ locale.groups_view_discussions_exclusive_group }}" title="{{ locale.groups_view_discussions_exclusive_group }}" class="header-bar-group-status" />{% elseif group.getGroupType() == 2%}<img src="{{ site.staticContentPath }}/web-gallery/images/groups/status_closed_big.gif" width="18" height="16" alt="{{ locale.groups_view_discussions_closed_group }}" title="{{ locale.groups_view_discussions_closed_group }}" class="header-bar-group-status" />{% endif %}   				    </h2>
    <ul class="box-tabs">
