...
<head>
	...
	<title>{{ site.siteName }}: Comunidade </title>
...
<div class="box-tabs-container clearfix">
    <h2>Quartos</h2>
    <ul class="box-tabs">
        <li id="tab-0-0-1"><a href="#">Top Quartos</a><span class="tab-spacer"></span></li>
        <li id="tab-0-0-2" class="selected"><a href="#">Quartos Recomendados</a><span class="tab-spacer"></span></li>
    </ul>
</div>
...
{% for room in recommendedRooms %}
    ...
    <span class="clearfix enter-room-link room-occupancy-{{ occupancyLevel }}" title="Go to room" roomid="{{ room.getData().getId() }}">
	    <span class="room-enter">Entrar no {{ site.siteName }} Hotel</span>
		...
		<span class="room-owner">Proprietário: <a href="{{ site.sitePath }}/home/{{ room.getData().getOwnerName() }}">{{ room.getData().getOwnerName() }}</a></span>
    </span>
</li>
{% set num = num + 1 %}
{% endfor %}
...
{% endautoescape %}
            ...
            <div class="clearfix">
                <a href="#" class="room-toggle-more-data" id="room-toggle-more-data-h119">Mostrar mais quartos</a>
            </div>
</div>
<script type="text/javascript">
L10N.put("show.more", "Mostrar mais quartos");
L10N.put("show.less", "Mostrar menos quartos");
...
<div class="box-tabs-container clearfix">
    <h2>Grupos</h2>
    <ul class="box-tabs">
        <li id="tab-0-1-1"><a href="#">Top Grupos</a><span class="tab-spacer"></span></li>
        <li id="tab-0-1-2" class="selected"><a href="#">Tópicos Recentes</a><span class="tab-spacer"></span></li>
    </ul>
...
<div class="clearfix">
    <a href="#" class="discussions-toggle-more-data secondary" id="discussions-toggle-more-data-h121">Mostrar mais tópicos</a>
</div>
<script type="text/javascript">
L10N.put("show.more.discussions", "Mostrar mais tópicos");
L10N.put("show.less.discussions", "Mostrar menos tópicos");
...
{% for habbo in randomHabbos %}
        <div id="active-habbo-data-{{ num }}" class="active-habbo-data">
                    <div class="active-habbo-data-container">
                        ...
                        {{ site.siteName }} criado em: {{ habbo.getCreatedAt() }}
...
<div id="column2" class="column">
        ...
        <div id="topstories">
	        ...
	        <div class="topstory" style="background-image: url({{ article2.getLiveTopStory() }}); display: none">
	            ...
	            <p>
	                <a href="{{ site.sitePath }}/articles/{{ article2.getUrl() }}">Leia mais &raquo;</a>
	            </p>
	        </div>
	        <div class="topstory" style="background-image: url({{ article3.getLiveTopStory() }}); display: none">
	            ...
	            <p>
	                <a href="{{ site.sitePath }}/articles/{{ article3.getUrl() }}">Leia mais &raquo;</a>
	            </p>
	        </div>
