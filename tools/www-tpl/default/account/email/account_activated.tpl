...
<head>
	...
	<title>{{ site.siteName }}{{ locale.account_email_email_activation }} </title>
...
<div class="cbb clearfix green">
    <h2 class="title" style="background-color: #429B00;">{{ locale.account_email_email_link_handled_successfully }}</h2>
    <div class="box-content">
        <span>
		{{ locale.account_email_your_email_address_is_now_verified }}
		<br>
...
<div class="cbb clearfix red">
    <h2 class="title">{{ locale.account_email_email_link_handled_unsuccessfully }}</h2>
    <div class="box-content">
        <span>
		{{ locale.account_email_the_activation_link_was_invalid }}
		<br>
		<a href="{{ site.sitePath }}/">{{ locale.account_email_continue_to }} {{ site.siteName }} {{ locale.account_email_front_page }}</a>
		</span>
    </div>
