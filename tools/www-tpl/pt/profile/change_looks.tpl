...
<h2 class="title">Mude o seu visual</h2>
<div class="box-content">

{% if settingsSavedAlert %}
<div class="rounded rounded-green">Configuração alteradas com sucesso!<br />	</div><br />
{% endif %}
	<div>&nbsp;</div>

<div id="settings-editor"><center>
Você precisa ter o Flash player instalado em seu computador antes de poder editar seu {{ site.siteName }}. Você pode baixá-lo <a target="_blank" href="https://atherosgames.blogspot.com/2023/10/adobe-flash-player-for-habbo-retros.html">aqui</a>.
</center><br></div>
