...
<body>
    ...
    <h1 class="mt-4">Artikel erstellen</h1>
		{% include "housekeeping/base/alert.tpl" %}
		<p>Erstelle einen Nachrichtenartikel. Sobald dieser veröffentlicht ist, wird er sofort auf der Seite veröffentlicht.</p>
		<form class="table-responsive" method="post">
			...
			<div class="form-group"> 
				<button type="submit" class="btn btn-info">Artikel erstellen</button>
			</div>
		</form>
    </div>
		<div style="margin-left:30px" class="col-3">
			<h1 class="mt-4">Artikelvorschau</h1>
				<p id="news-preview"><i>Vorschau der Nachricht hier ...</i></p>
    	</div>
	</div>
