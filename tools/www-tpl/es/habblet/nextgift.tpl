                    ...
                    <div class="gift-content-container">
					  ...
					  {% if newbieNextGift == 1 %}
                        Tu próximo mueble gratis será <strong>STARTER STOOL</strong>
					  {% elseif newbieNextGift == 2 %}
						Tu próximo mueble gratis será <strong>LUCKY BAMBOO PLANT</strong>
					  {% endif %}
					  </p>
                      <p>
                      ...
                      <p class="last">
                        <a class="new-button green-button" href="{{ site.sitePath }}/client?forwardId=2&roomId={{ playerDetails.getSelectedRoomId() }}" target="client" onclick="HabboClient.roomForward(this, '{{ playerDetails.getSelectedRoomId() }}', 'private'); return false;"><b>Ve a tu cuarto &gt;&gt;</b><i></i></a>
                      </p>
                      <br style="clear: both" />
                    </div>
