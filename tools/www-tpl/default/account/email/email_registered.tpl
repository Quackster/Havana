...
<p style="font-size: 18px;"><b>{{ locale.account_email_welcome_to }} {{ site.siteName}}, {{ playerName }}!</b></p>
<p>{{ locale.account_email_thanks_for_registering_at }} <a style="color: #66b3ff" href="{{ site.sitePath }}/?email">{{ site.emailHotelName }}</a>.</p>
