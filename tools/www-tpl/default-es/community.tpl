...
<div id="navi2-container" class="pngbg">
    <div id="navi2" class="pngbg clearfix">
		<ul>
    		...
    		<li class="">
				<a href="{{ site.sitePath }}/tag">YoSoys</a>    		</li>
    		<li class="">
...
<div class="box-tabs-container clearfix">
    <h2>Salas</h2>
    <ul class="box-tabs">
        <li id="tab-0-0-1"><a href="#">Lo más votado</a><span class="tab-spacer"></span></li>
        <li id="tab-0-0-2" class="selected"><a href="#">Salas recomendadas</a><span class="tab-spacer"></span></li>
    </ul>
</div>
...
{% for room in recommendedRooms %}
    ...
    <span class="clearfix enter-room-link room-occupancy-{{ occupancyLevel }}" title="Go to room" roomid="{{ room.getData().getId() }}">
	    <span class="room-enter">Entrar a {{ site.siteName }} Hotel</span>
...
{% endautoescape %}
            ...
            <div class="clearfix">
                <a href="#" class="room-toggle-more-data" id="room-toggle-more-data-h119">Mostrar más salas</a>
            </div>
</div>
<script type="text/javascript">
...
<div class="clearfix">
    <a href="#" class="discussions-toggle-more-data secondary" id="discussions-toggle-more-data-h121">Mostrar más temas</a>
</div>
<script type="text/javascript">
...
var discussionMoreDataHelper = new MoreDataHelper("discussions-toggle-more-data-h121", "active-discussions-toplist-hidden-h121","discussions");
				...
				<div class="habblet-container ">		
						<div class="cbb clearfix activehomes ">
							...
							<h2 class="title">{{ site.siteName }}s al azar - ¡Haz clic!							</h2>
...
<div id="column2" class="column">
        ...
        <div id="topstories">
            ...
            <div id="topstories-nav" style="display: none"><a href="#" class="prev">&laquo; Atras</a><span>1</span> / 3<a href="#" class="next">Siguiente &raquo</a></div>
        </div>
        <ul class="widelist">
            <li class="even">
